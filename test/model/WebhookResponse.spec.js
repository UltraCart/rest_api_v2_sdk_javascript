...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UltraCartRestApiV2.WebhookResponse();
  });
  ...
  describe('WebhookResponse', function() {
    it('should create an instance of WebhookResponse', function() {
      ...
      //var instane = new UltraCartRestApiV2.WebhookResponse();
      //expect(instance).to.be.a(UltraCartRestApiV2.WebhookResponse);
    });
