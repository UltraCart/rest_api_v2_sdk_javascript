...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UltraCartRestApiV2.AffiliateLedger();
  });
  ...
  describe('AffiliateLedger', function() {
    it('should create an instance of AffiliateLedger', function() {
      // uncomment below and update the code to test AffiliateLedger
      //var instane = new UltraCartRestApiV2.AffiliateLedger();
      //expect(instance).to.be.a(UltraCartRestApiV2.AffiliateLedger);
    });
    ...
    it('should have the property originalTransactionDts (base name: "original_transaction_dts")', function() {
      // uncomment below and update the code to test the property originalTransactionDts
      //var instane = new UltraCartRestApiV2.AffiliateLedger();
      //expect(instance).to.be();
    });
