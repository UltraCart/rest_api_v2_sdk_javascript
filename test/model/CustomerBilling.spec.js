...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UltraCartRestApiV2.CustomerBilling();
  });
  ...
  describe('CustomerBilling', function() {
    it('should create an instance of CustomerBilling', function() {
      // uncomment below and update the code to test CustomerBilling
      //var instane = new UltraCartRestApiV2.CustomerBilling();
      //expect(instance).to.be.a(UltraCartRestApiV2.CustomerBilling);
    });
    ...
    it('should have the property customerBillingOid (base name: "customer_billing_oid")', function() {
      // uncomment below and update the code to test the property customerBillingOid
      //var instane = new UltraCartRestApiV2.CustomerBilling();
      //expect(instance).to.be();
    });
