...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UltraCartRestApiV2.AddLibraryItemRequest();
  });
  ...
  describe('AddLibraryItemRequest', function() {
    it('should create an instance of AddLibraryItemRequest', function() {
      // uncomment below and update the code to test AddLibraryItemRequest
      //var instane = new UltraCartRestApiV2.AddLibraryItemRequest();
      //expect(instance).to.be.a(UltraCartRestApiV2.AddLibraryItemRequest);
    });
