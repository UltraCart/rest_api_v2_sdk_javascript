...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UltraCartRestApiV2.EmailCustomersResponse();
  });
  ...
  describe('EmailCustomersResponse', function() {
    it('should create an instance of EmailCustomersResponse', function() {
      // uncomment below and update the code to test EmailCustomersResponse
      //var instane = new UltraCartRestApiV2.EmailCustomersResponse();
      //expect(instance).to.be.a(UltraCartRestApiV2.EmailCustomersResponse);
    });
