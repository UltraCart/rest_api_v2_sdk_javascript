...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UltraCartRestApiV2.EmailSegment();
  });
  ...
  describe('EmailSegment', function() {
    it('should create an instance of EmailSegment', function() {
      // uncomment below and update the code to test EmailSegment
