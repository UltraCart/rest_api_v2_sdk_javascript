...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UltraCartRestApiV2.CartKitComponentOption();
  });
  ...
  describe('CartKitComponentOption', function() {
    it('should create an instance of CartKitComponentOption', function() {
      // uncomment below and update the code to test CartKitComponentOption
      //var instane = new UltraCartRestApiV2.CartKitComponentOption();
      //expect(instance).to.be.a(UltraCartRestApiV2.CartKitComponentOption);
    });
