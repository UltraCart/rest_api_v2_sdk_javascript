...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UltraCartRestApiV2.OrderAutoOrder();
  });
  ...
  describe('OrderAutoOrder', function() {
    it('should create an instance of OrderAutoOrder', function() {
      // uncomment below and update the code to test OrderAutoOrder
      //var instane = new UltraCartRestApiV2.OrderAutoOrder();
      //expect(instance).to.be.a(UltraCartRestApiV2.OrderAutoOrder);
    });
