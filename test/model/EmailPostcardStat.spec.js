...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UltraCartRestApiV2.EmailPostcardStat();
  });
  ...
  describe('EmailPostcardStat', function() {
    it('should create an instance of EmailPostcardStat', function() {
      // uncomment below and update the code to test EmailPostcardStat
      //var instane = new UltraCartRestApiV2.EmailPostcardStat();
      //expect(instance).to.be.a(UltraCartRestApiV2.EmailPostcardStat);
    });
    ...
    it('should have the property returnToSenderCount (base name: "return_to_sender_count")', function() {
      // uncomment below and update the code to test the property returnToSenderCount
      //var instane = new UltraCartRestApiV2.EmailPostcardStat();
      //expect(instance).to.be();
    });

    it('should have the property returnToSenderCountFormatted (base name: "return_to_sender_count_formatted")', function() {
      // uncomment below and update the code to test the property returnToSenderCountFormatted
      //var instane = new UltraCartRestApiV2.EmailPostcardStat();
      //expect(instance).to.be();
    });
