...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UltraCartRestApiV2.EmailPlanAdditional();
  });
  ...
  describe('EmailPlanAdditional', function() {
    it('should create an instance of EmailPlanAdditional', function() {
      // uncomment below and update the code to test EmailPlanAdditional
    ...
    it('should have the property costFormatted (base name: "cost_formatted")', function() {
      // uncomment below and update the code to test the property costFormatted
      //var instane = new UltraCartRestApiV2.EmailPlanAdditional();
      //expect(instance).to.be();
    });
