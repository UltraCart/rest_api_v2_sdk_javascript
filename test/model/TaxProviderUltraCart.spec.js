...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UltraCartRestApiV2.TaxProviderUltraCart();
  });
  ...
  describe('TaxProviderUltraCart', function() {
    it('should create an instance of TaxProviderUltraCart', function() {
      // uncomment below and update the code to test TaxProviderUltraCart
      //var instane = new UltraCartRestApiV2.TaxProviderUltraCart();
      //expect(instance).to.be.a(UltraCartRestApiV2.TaxProviderUltraCart);
    });
