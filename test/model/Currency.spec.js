...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UltraCartRestApiV2.Currency();
  });
  ...
  describe('Currency', function() {
    ...
    it('should have the property localizedFormatted (base name: "localized_formatted")', function() {
      // uncomment below and update the code to test the property localizedFormatted
      //var instane = new UltraCartRestApiV2.Currency();
      //expect(instance).to.be();
    });
