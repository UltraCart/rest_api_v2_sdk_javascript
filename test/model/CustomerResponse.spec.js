...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UltraCartRestApiV2.CustomerResponse();
  });
  ...
  describe('CustomerResponse', function() {
    it('should create an instance of CustomerResponse', function() {
      ...
      //var instane = new UltraCartRestApiV2.CustomerResponse();
      //expect(instance).to.be.a(UltraCartRestApiV2.CustomerResponse);
    });
