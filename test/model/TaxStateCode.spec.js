...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UltraCartRestApiV2.TaxStateCode();
  });
  ...
  describe('TaxStateCode', function() {
    it('should create an instance of TaxStateCode', function() {
      // uncomment below and update the code to test TaxStateCode
      //var instane = new UltraCartRestApiV2.TaxStateCode();
      //expect(instance).to.be.a(UltraCartRestApiV2.TaxStateCode);
    });
