...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UltraCartRestApiV2.EmailThirdPartyProvider();
  });
  ...
  describe('EmailThirdPartyProvider', function() {
    it('should create an instance of EmailThirdPartyProvider', function() {
      // uncomment below and update the code to test EmailThirdPartyProvider
