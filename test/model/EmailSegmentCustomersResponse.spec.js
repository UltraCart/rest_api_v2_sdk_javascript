...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UltraCartRestApiV2.EmailSegmentCustomersResponse();
  });
  ...
  describe('EmailSegmentCustomersResponse', function() {
    it('should create an instance of EmailSegmentCustomersResponse', function() {
      // uncomment below and update the code to test EmailSegmentCustomersResponse
      //var instane = new UltraCartRestApiV2.EmailSegmentCustomersResponse();
      //expect(instance).to.be.a(UltraCartRestApiV2.EmailSegmentCustomersResponse);
    });
