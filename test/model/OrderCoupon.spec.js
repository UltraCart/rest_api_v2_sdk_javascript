...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UltraCartRestApiV2.OrderCoupon();
  });
  ...
  describe('OrderCoupon', function() {
    it('should create an instance of OrderCoupon', function() {
      // uncomment below and update the code to test OrderCoupon
      //var instane = new UltraCartRestApiV2.OrderCoupon();
      //expect(instance).to.be.a(UltraCartRestApiV2.OrderCoupon);
    });
