...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UltraCartRestApiV2.OrderBilling();
  });
  ...
  describe('OrderBilling', function() {
    it('should create an instance of OrderBilling', function() {
      // uncomment below and update the code to test OrderBilling
      //var instane = new UltraCartRestApiV2.OrderBilling();
      //expect(instance).to.be.a(UltraCartRestApiV2.OrderBilling);
    });
