...
**arbitrary_subtotal_discount** | **Number** | Arbitrary subtotal discount for overriding the calculated subtotal discount.  Send the gross price in the item arbitrary unit cost and the discount here. | [optional] 
...
**arbitrary_taxable_subtotal_discount** | **Number** | Arbitrary taxable subtotal discount.  If an arbitrary subtotal discount is supplied without this field, the arbitrary subtotal discount is used for both. | [optional] 
