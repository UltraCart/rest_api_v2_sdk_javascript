...
**emails** | [**[OrderEmail]**](OrderEmail.md) | Email delivery records associated with this order. | [optional] 
...
**properties** | [**[OrderProperty]**](OrderProperty.md) | Properties associated with the order | [optional] 
