...
var order_id = "order_id_example"; // String | The order id to assign to the affiliate.

var assign_to_affiliate_request = new UltraCartRestApiV2.OrderAssignToAffiliateRequest(); // OrderAssignToAffiliateRequest | Assign to affiliate request
...
apiInstance.assignToAffiliate(order_id, assign_to_affiliate_request, opts, callback);
```
...
# **getOrderUpsellCart**
> OrderResponse getOrderUpsellCart(upsell_cart_request, order_id, opts)
...
var upsell_cart_request = new UltraCartRestApiV2.OrderUpsellCartRequest(); // OrderUpsellCartRequest | Request for the upsell cart

var order_id = "order_id_example"; // String | The order id to base things on.
...
apiInstance.getOrderUpsellCart(upsell_cart_request, order_id, opts, callback);
```
...
> OrderResponse heldOrderAddItemsAndRelease(add_items_and_release_request, order_id, opts)
...
var add_items_and_release_request = new UltraCartRestApiV2.OrderAddItemsAndReleaseRequest(); // OrderAddItemsAndReleaseRequest | Add items and release request

var order_id = "order_id_example"; // String | The order id to release.
...
apiInstance.heldOrderAddItemsAndRelease(add_items_and_release_request, order_id, opts, callback);
```
...
apiInstance.heldOrderRelease(order_id, opts, callback);
```
