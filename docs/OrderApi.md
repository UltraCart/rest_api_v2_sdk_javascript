...
<!-- UC_START_EXAMPLE assignToAffiliate -->
...
<!-- UC_END_EXAMPLE assignToAffiliate -->
...
<!-- UC_START_EXAMPLE blockRefundOnOrder -->
...
<!-- UC_END_EXAMPLE blockRefundOnOrder -->
...
<!-- UC_START_EXAMPLE getOrderCustomerActivity -->
...
let order_id = "order_id_example"; // String | The order id to retrieve customer activity for.
apiInstance.getOrderCustomerActivity(order_id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
<!-- UC_END_EXAMPLE getOrderCustomerActivity -->
...
<!-- UC_START_EXAMPLE heldOrderAddItemsAndRelease -->
...
<!-- UC_END_EXAMPLE heldOrderAddItemsAndRelease -->
...
<!-- UC_START_EXAMPLE heldOrderRelease -->
...
<!-- UC_END_EXAMPLE heldOrderRelease -->
...
<!-- UC_START_EXAMPLE replaceOrderItemMerchantItemId -->
...
<!-- UC_END_EXAMPLE replaceOrderItemMerchantItemId -->
...
<!-- UC_START_EXAMPLE unblockRefundOnOrder -->
...
<!-- UC_END_EXAMPLE unblockRefundOnOrder -->
