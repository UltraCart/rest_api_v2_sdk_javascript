...
**storefront_oid** | **Number** | Optional storefront oid.  Required when theme_oid is supplied. | [optional] 
**theme_oid** | **Number** | Optional theme oid.  Supplies the theme&#39;s inherit groups configuration so compilation matches what the theme would produce.  Omit to compile without inheritance. | [optional] 
