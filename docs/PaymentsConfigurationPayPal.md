...
**processing_fee** | **Number** | Optional additional fee to charge if PayPal is used.  It is rare for this to be used. | [optional] 
**processing_percentage** | **Number** | The processing percentage charged by PayPal | [optional] 
