# UltraCartRestApiV2.ItemVariantItem
...
**quantity** | **Number** | Quantity of the variant item added to the cart when this combination is selected.  Defaults to 1. | [optional] 
