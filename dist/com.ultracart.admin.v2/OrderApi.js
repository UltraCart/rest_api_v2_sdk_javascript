...
var OrderApi = exports["default"] = /*#__PURE__*/function () {
  ...
  */
  ...
  return _createClass(OrderApi, [{
    ...
    key: "assignToAffiliate",
    value: function assignToAffiliate(order_id, assign_to_affiliate_request, opts, callback) {
      opts = opts || {};
      var postBody = assign_to_affiliate_request;
      // verify the required parameter 'order_id' is set
      if (order_id === undefined || order_id === null) {
      ...
      return this.apiClient.callApi('/order/orders/{order_id}/assignToAffiliate', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    ...
    key: "blockRefundOnOrder",
    value: function blockRefundOnOrder(order_id, opts, callback) {
      opts = opts || {};
      var postBody = null;
      // verify the required parameter 'order_id' is set
      if (order_id === undefined || order_id === null) {
      ...
      var accepts = ['application/json'];
      var returnType = null;
      return this.apiClient.callApi('/order/orders/{order_id}/refund_block', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    ...
    key: "getOrderCustomerActivity",
    value: function getOrderCustomerActivity(order_id, callback) {
      var postBody = null;
      // verify the required parameter 'order_id' is set
      if (order_id === undefined || order_id === null) {
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = _OrderCustomerActivityResponse["default"];
      return this.apiClient.callApi('/order/orders/{order_id}/customer_activity', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    ...
    key: "unblockRefundOnOrder",
    value: function unblockRefundOnOrder(order_id, callback) {
      var postBody = null;
      // verify the required parameter 'order_id' is set
      if (order_id === undefined || order_id === null) {
      ...
      var accepts = ['application/json'];
      var returnType = null;
      return this.apiClient.callApi('/order/orders/{order_id}/refund_unblock', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
