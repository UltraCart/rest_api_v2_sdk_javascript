  ...
  */
  ...
  return _createClass(OrderApi, [{
    ...
    value: function blockRefundOnOrder(order_id, opts, callback) {
      ...
      var accepts = ['application/json'];
      var returnType = null;
      return this.apiClient.callApi('/order/orders/{order_id}/refund_block', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    ...
    value: function unblockRefundOnOrder(order_id, callback) {
      ...
      var accepts = ['application/json'];
      var returnType = null;
      return this.apiClient.callApi('/order/orders/{order_id}/refund_unblock', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
