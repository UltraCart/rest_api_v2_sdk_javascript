 ...
 * @version 4.1.41
 */
var ItemShippingDistributionCenterResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function ItemShippingDistributionCenterResponse() {
    _classCallCheck(this, ItemShippingDistributionCenterResponse);
   ...
   */
  return _createClass(ItemShippingDistributionCenterResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('itemShippingDistributionCenter')) {
          obj['itemShippingDistributionCenter'] = _ItemShippingDistributionCenter["default"].constructFromObject(data['itemShippingDistributionCenter']);
        }
...
var _default = exports["default"] = ItemShippingDistributionCenterResponse;