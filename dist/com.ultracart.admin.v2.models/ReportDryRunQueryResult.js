...
var ReportDryRunQueryResult = /*#__PURE__*/function () {
   ...
   */
  function ReportDryRunQueryResult() {
    _classCallCheck(this, ReportDryRunQueryResult);
  ...
  _createClass(ReportDryRunQueryResult, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('total_bytes_processed')) {
          obj['total_bytes_processed'] = _ApiClient["default"].convertToType(data['total_bytes_processed'], 'Number');
        }
      }
  ...
  return ReportDryRunQueryResult;
}();
/**
...
var _default = ReportDryRunQueryResult;
