...
var _ConversationPbxMenu = _interopRequireDefault(require("./ConversationPbxMenu"));
var _ConversationPbxQueue = _interopRequireDefault(require("./ConversationPbxQueue"));
var _ConversationPbxVoicemailMailbox = _interopRequireDefault(require("./ConversationPbxVoicemailMailbox"));
...
var ConversationPbxAudioUsageResponse = /*#__PURE__*/function () {
   ...
   */
  function ConversationPbxAudioUsageResponse() {
    _classCallCheck(this, ConversationPbxAudioUsageResponse);
   ...
   */
  return _createClass(ConversationPbxAudioUsageResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('menus')) {
          obj['menus'] = _ApiClient["default"].convertToType(data['menus'], [_ConversationPbxMenu["default"]]);
        }
        if (data.hasOwnProperty('metadata')) {
          obj['metadata'] = _ResponseMetadata["default"].constructFromObject(data['metadata']);
        }
        if (data.hasOwnProperty('queues')) {
          obj['queues'] = _ApiClient["default"].convertToType(data['queues'], [_ConversationPbxQueue["default"]]);
        }
        if (data.hasOwnProperty('success')) {
          obj['success'] = _ApiClient["default"].convertToType(data['success'], 'Boolean');
        }
        if (data.hasOwnProperty('voicemail_mailboxes')) {
          obj['voicemail_mailboxes'] = _ApiClient["default"].convertToType(data['voicemail_mailboxes'], [_ConversationPbxVoicemailMailbox["default"]]);
        }
...
var _default = exports["default"] = ConversationPbxAudioUsageResponse;