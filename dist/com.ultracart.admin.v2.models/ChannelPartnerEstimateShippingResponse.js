...
var _ChannelPartnerShippingEstimate = _interopRequireDefault(require("./ChannelPartnerShippingEstimate"));
...
var ChannelPartnerEstimateShippingResponse = /*#__PURE__*/function () {
   ...
   */
  function ChannelPartnerEstimateShippingResponse() {
    _classCallCheck(this, ChannelPartnerEstimateShippingResponse);
  ...
  _createClass(ChannelPartnerEstimateShippingResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('estimates')) {
          obj['estimates'] = _ApiClient["default"].convertToType(data['estimates'], [_ChannelPartnerShippingEstimate["default"]]);
        }
...
var _default = ChannelPartnerEstimateShippingResponse;
