...
var _TransactionEmail = _interopRequireDefault(require("./TransactionEmail"));
 ...
 * @version 4.0.181
 */
var TransactionEmailResponse = /*#__PURE__*/function () {
  /**
  ...
  function TransactionEmailResponse() {
    _classCallCheck(this, TransactionEmailResponse);
  ...
  _createClass(TransactionEmailResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('email')) {
          obj['email'] = _TransactionEmail["default"].constructFromObject(data['email']);
        }
...
var _default = TransactionEmailResponse;
