...
var _ItemKitComponent = _interopRequireDefault(require("./ItemKitComponent"));
 ...
 * @version 4.0.84-RC
 */
var ItemKitDefinition = /*#__PURE__*/function () {
  /**
  ...
  function ItemKitDefinition() {
    _classCallCheck(this, ItemKitDefinition);
  ...
  _createClass(ItemKitDefinition, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('components')) {
          obj['components'] = _ApiClient["default"].convertToType(data['components'], [_ItemKitComponent["default"]]);
        }
      }
...
var _default = ItemKitDefinition;
