 ...
 * @version 4.0.114-RC
 */
var EmailBaseTemplateListResponse = /*#__PURE__*/function () {
  /**
  ...
  function EmailBaseTemplateListResponse() {
    _classCallCheck(this, EmailBaseTemplateListResponse);
  ...
  _createClass(EmailBaseTemplateListResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('templatePaths')) {
          obj['templatePaths'] = _ApiClient["default"].convertToType(data['templatePaths'], ['String']);
        }
      }
...
var _default = EmailBaseTemplateListResponse;
