 ...
 * @version 4.1.12
 */
var ConversationPbxAgentsResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function ConversationPbxAgentsResponse() {
    _classCallCheck(this, ConversationPbxAgentsResponse);
   ...
   */
  return _createClass(ConversationPbxAgentsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('agents')) {
          obj['agents'] = _ApiClient["default"].convertToType(data['agents'], [_ConversationPbxAgent["default"]]);
        }
...
var _default = exports["default"] = ConversationPbxAgentsResponse;