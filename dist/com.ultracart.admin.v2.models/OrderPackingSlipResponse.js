...
var OrderPackingSlipResponse = /*#__PURE__*/function () {
   ...
   */
  function OrderPackingSlipResponse() {
    _classCallCheck(this, OrderPackingSlipResponse);
  ...
  _createClass(OrderPackingSlipResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('pdfBase64')) {
          obj['pdfBase64'] = _ApiClient["default"].convertToType(data['pdfBase64'], 'String');
        }
...
var _default = OrderPackingSlipResponse;
