...
var OrderQuery = /*#__PURE__*/function () {
   ...
   */
  return _createClass(OrderQuery, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('custom_field_10')) {
          obj['custom_field_10'] = _ApiClient["default"].convertToType(data['custom_field_10'], 'String');
        }
        ...
        if (data.hasOwnProperty('custom_field_8')) {
          obj['custom_field_8'] = _ApiClient["default"].convertToType(data['custom_field_8'], 'String');
        }
        if (data.hasOwnProperty('custom_field_9')) {
          obj['custom_field_9'] = _ApiClient["default"].convertToType(data['custom_field_9'], 'String');
        }
 ...
 */
OrderQuery.prototype['custom_field_10'] = undefined;
 ...
 */
OrderQuery.prototype['custom_field_8'] = undefined;

/**
 * Custom field 9
 * @member {String} custom_field_9
 */
OrderQuery.prototype['custom_field_9'] = undefined;
 ...
 */
OrderQuery.prototype['query_target'] = undefined;
...
var _default = exports["default"] = OrderQuery;