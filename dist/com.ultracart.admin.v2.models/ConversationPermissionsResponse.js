...
var _ConversationPermissions = _interopRequireDefault(require("./ConversationPermissions"));
 ...
 * @version 4.0.183
 */
var ConversationPermissionsResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function ConversationPermissionsResponse() {
    _classCallCheck(this, ConversationPermissionsResponse);
  ...
  _createClass(ConversationPermissionsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('permissions')) {
          obj['permissions'] = _ConversationPermissions["default"].constructFromObject(data['permissions']);
        }
...
var _default = ConversationPermissionsResponse;
