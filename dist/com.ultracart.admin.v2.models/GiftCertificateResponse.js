...
var GiftCertificateResponse = /*#__PURE__*/function () {
   ...
   */
  function GiftCertificateResponse() {
    _classCallCheck(this, GiftCertificateResponse);
  ...
  _createClass(GiftCertificateResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('gift_certificate')) {
          obj['gift_certificate'] = _GiftCertificate["default"].constructFromObject(data['gift_certificate']);
        }
...
var _default = GiftCertificateResponse;
