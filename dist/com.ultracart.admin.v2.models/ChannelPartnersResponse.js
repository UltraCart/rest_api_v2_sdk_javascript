 ...
 * @version 4.0.148
 */
var ChannelPartnersResponse = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ChannelPartnersResponse</code>.
   * @alias module:com.ultracart.admin.v2.models/ChannelPartnersResponse
   */
  function ChannelPartnersResponse() {
    _classCallCheck(this, ChannelPartnersResponse);
  ...
  _createClass(ChannelPartnersResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('channelPartners')) {
          obj['channelPartners'] = _ApiClient["default"].convertToType(data['channelPartners'], [_ChannelPartner["default"]]);
        }
...
var _default = ChannelPartnersResponse;
