...
var _EmailDomain = _interopRequireDefault(require("./EmailDomain"));
 ...
 * @version 4.0.144
 */
var EmailSendingDomainsResponse = /*#__PURE__*/function () {
  /**
  ...
  function EmailSendingDomainsResponse() {
    _classCallCheck(this, EmailSendingDomainsResponse);
  ...
  _createClass(EmailSendingDomainsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('domains')) {
          obj['domains'] = _ApiClient["default"].convertToType(data['domains'], [_EmailDomain["default"]]);
        }
...
var _default = EmailSendingDomainsResponse;
