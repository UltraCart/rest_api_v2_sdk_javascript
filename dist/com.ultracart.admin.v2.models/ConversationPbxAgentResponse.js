...
var _ConversationPbxAgent = _interopRequireDefault(require("./ConversationPbxAgent"));
 ...
 * @version 4.1.54
 */
var ConversationPbxAgentResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function ConversationPbxAgentResponse() {
    _classCallCheck(this, ConversationPbxAgentResponse);
   ...
   */
  return _createClass(ConversationPbxAgentResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('agent')) {
          obj['agent'] = _ConversationPbxAgent["default"].constructFromObject(data['agent']);
        }
...
var _default = exports["default"] = ConversationPbxAgentResponse;