...
var _CustomerStoreCredit = _interopRequireDefault(require("./CustomerStoreCredit"));
 ...
 * @version 4.0.121-RC
 */
var CustomerStoreCreditResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function CustomerStoreCreditResponse() {
    _classCallCheck(this, CustomerStoreCreditResponse);
  ...
  _createClass(CustomerStoreCreditResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('customer_store_credit')) {
          obj['customer_store_credit'] = _CustomerStoreCredit["default"].constructFromObject(data['customer_store_credit']);
        }
...
var _default = CustomerStoreCreditResponse;
