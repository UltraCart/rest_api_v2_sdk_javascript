...
var ReportResponse = /*#__PURE__*/function () {
  ...
  _createClass(ReportResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('report')) {
          obj['report'] = _Report["default"].constructFromObject(data['report']);
        }
