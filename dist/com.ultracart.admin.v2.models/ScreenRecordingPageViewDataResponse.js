...
var ScreenRecordingPageViewDataResponse = /*#__PURE__*/function () {
   ...
   */
  function ScreenRecordingPageViewDataResponse() {
    _classCallCheck(this, ScreenRecordingPageViewDataResponse);
  ...
  _createClass(ScreenRecordingPageViewDataResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('events_json')) {
          obj['events_json'] = _ApiClient["default"].convertToType(data['events_json'], 'String');
        }
...
var _default = ScreenRecordingPageViewDataResponse;
