 ...
 * @version 4.0.171
 */
var ReportDataSetResponse = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ReportDataSetResponse</code>.
   * @alias module:com.ultracart.admin.v2.models/ReportDataSetResponse
   */
  function ReportDataSetResponse() {
    _classCallCheck(this, ReportDataSetResponse);
  ...
  _createClass(ReportDataSetResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data_set')) {
          obj['data_set'] = _ReportDataSet["default"].constructFromObject(data['data_set']);
        }
...
var _default = ReportDataSetResponse;
