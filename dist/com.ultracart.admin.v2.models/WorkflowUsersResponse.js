...
var WorkflowUsersResponse = /*#__PURE__*/function () {
   ...
   */
  return _createClass(WorkflowUsersResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('my_user_id')) {
          obj['my_user_id'] = _ApiClient["default"].convertToType(data['my_user_id'], 'Number');
        }
...
var _default = exports["default"] = WorkflowUsersResponse;