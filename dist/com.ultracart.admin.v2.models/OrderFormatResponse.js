...
var OrderFormatResponse = /*#__PURE__*/function () {
  ...
  function OrderFormatResponse() {
    _classCallCheck(this, OrderFormatResponse);
  ...
  _createClass(OrderFormatResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('css_links')) {
          obj['css_links'] = _ApiClient["default"].convertToType(data['css_links'], ['String']);
        }

        if (data.hasOwnProperty('formatted_result')) {
          obj['formatted_result'] = _ApiClient["default"].convertToType(data['formatted_result'], 'String');
        }
      }
...
var _default = OrderFormatResponse;
