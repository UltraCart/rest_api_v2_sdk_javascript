 ...
 * @version 4.0.178
 */
var EmailCommseqPostcardsRequest = /*#__PURE__*/function () {
  /**
  ...
  function EmailCommseqPostcardsRequest() {
    _classCallCheck(this, EmailCommseqPostcardsRequest);
  ...
  _createClass(EmailCommseqPostcardsRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('esp_commseq_postcard_uuids')) {
          obj['esp_commseq_postcard_uuids'] = _ApiClient["default"].convertToType(data['esp_commseq_postcard_uuids'], ['String']);
        }
      }
...
var _default = EmailCommseqPostcardsRequest;
