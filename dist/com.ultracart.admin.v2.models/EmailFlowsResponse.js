...
var EmailFlowsResponse = /*#__PURE__*/function () {
  ...
  function EmailFlowsResponse() {
    _classCallCheck(this, EmailFlowsResponse);
  ...
  _createClass(EmailFlowsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('flows')) {
          obj['flows'] = _ApiClient["default"].convertToType(data['flows'], [_EmailFlow["default"]]);
        }
...
var _default = EmailFlowsResponse;
