...
var _ConversationPbxVoicemailMessage = _interopRequireDefault(require("./ConversationPbxVoicemailMessage"));
 ...
 * @version 4.1.30
 */
var ConversationPbxVoicemailMessageResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function ConversationPbxVoicemailMessageResponse() {
    _classCallCheck(this, ConversationPbxVoicemailMessageResponse);
   ...
   */
  return _createClass(ConversationPbxVoicemailMessageResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('voicemail_message')) {
          obj['voicemail_message'] = _ConversationPbxVoicemailMessage["default"].constructFromObject(data['voicemail_message']);
        }
...
var _default = exports["default"] = ConversationPbxVoicemailMessageResponse;