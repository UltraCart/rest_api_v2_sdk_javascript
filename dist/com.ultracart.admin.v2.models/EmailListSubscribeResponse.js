 ...
 * @version 4.0.101-RC
 */
var EmailListSubscribeResponse = /*#__PURE__*/function () {
  /**
  ...
  function EmailListSubscribeResponse() {
    _classCallCheck(this, EmailListSubscribeResponse);
  ...
  _createClass(EmailListSubscribeResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('added')) {
          obj['added'] = _ApiClient["default"].convertToType(data['added'], 'Number');
        }
...
var _default = EmailListSubscribeResponse;
