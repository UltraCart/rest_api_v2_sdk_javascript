 ...
 * @version 4.0.84-RC
 */
var EmailCommseqEmailSendTestRequest = /*#__PURE__*/function () {
  /**
  ...
  function EmailCommseqEmailSendTestRequest() {
    _classCallCheck(this, EmailCommseqEmailSendTestRequest);
  ...
  _createClass(EmailCommseqEmailSendTestRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('esp_commseq_email_uuid')) {
          obj['esp_commseq_email_uuid'] = _ApiClient["default"].convertToType(data['esp_commseq_email_uuid'], 'String');
        }
        ...
        if (data.hasOwnProperty('send_to_additional_emails')) {
          obj['send_to_additional_emails'] = _ApiClient["default"].convertToType(data['send_to_additional_emails'], ['String']);
        }
...
var _default = EmailCommseqEmailSendTestRequest;
