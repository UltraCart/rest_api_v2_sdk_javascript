...
var ReportsResponse = /*#__PURE__*/function () {
  ...
  function ReportsResponse() {
    _classCallCheck(this, ReportsResponse);
  ...
  _createClass(ReportsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('reports')) {
          obj['reports'] = _ApiClient["default"].convertToType(data['reports'], [_Report["default"]]);
        }
