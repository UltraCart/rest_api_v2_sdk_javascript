 ...
 * @version 4.1.54
 */
var ConversationPbxVoicemailMessage = /*#__PURE__*/function () {
  /**
  ...
  function ConversationPbxVoicemailMessage() {
    _classCallCheck(this, ConversationPbxVoicemailMessage);
   ...
   */
  return _createClass(ConversationPbxVoicemailMessage, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('transcript_json')) {
          obj['transcript_json'] = _ApiClient["default"].convertToType(data['transcript_json'], 'String');
        }
        if (data.hasOwnProperty('transcript_text')) {
          obj['transcript_text'] = _ApiClient["default"].convertToType(data['transcript_text'], 'String');
        }
...
var _default = exports["default"] = ConversationPbxVoicemailMessage;