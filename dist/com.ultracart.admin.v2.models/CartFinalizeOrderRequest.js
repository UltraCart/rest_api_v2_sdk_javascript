...
var _CartFinalizeOrderRequestOptions = _interopRequireDefault(require("./CartFinalizeOrderRequestOptions"));
...
var CartFinalizeOrderRequest = /*#__PURE__*/function () {
  ...
  function CartFinalizeOrderRequest() {
    _classCallCheck(this, CartFinalizeOrderRequest);
  ...
  _createClass(CartFinalizeOrderRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('options')) {
          obj['options'] = _CartFinalizeOrderRequestOptions["default"].constructFromObject(data['options']);
        }
      }
...
var _default = CartFinalizeOrderRequest;
