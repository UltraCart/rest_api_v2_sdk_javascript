 ...
 * @version 4.0.100-RC
 */
var EmailCommseqEmailsRequest = /*#__PURE__*/function () {
  /**
  ...
  function EmailCommseqEmailsRequest() {
    _classCallCheck(this, EmailCommseqEmailsRequest);
  ...
  _createClass(EmailCommseqEmailsRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('esp_commseq_email_uuids')) {
          obj['esp_commseq_email_uuids'] = _ApiClient["default"].convertToType(data['esp_commseq_email_uuids'], ['String']);
        }
...
var _default = EmailCommseqEmailsRequest;
