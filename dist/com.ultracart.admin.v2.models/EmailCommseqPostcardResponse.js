 ...
 * @version 4.0.189
 */
var EmailCommseqPostcardResponse = /*#__PURE__*/function () {
  /**
  ...
  function EmailCommseqPostcardResponse() {
    _classCallCheck(this, EmailCommseqPostcardResponse);
  ...
  _createClass(EmailCommseqPostcardResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('postcard')) {
          obj['postcard'] = _EmailCommseqPostcard["default"].constructFromObject(data['postcard']);
        }
...
var _default = EmailCommseqPostcardResponse;
