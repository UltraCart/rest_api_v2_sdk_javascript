...
var _LibraryFilterValues = _interopRequireDefault(require("./LibraryFilterValues"));
...
var LibraryFilterValuesResponse = /*#__PURE__*/function () {
  ...
  function LibraryFilterValuesResponse() {
    _classCallCheck(this, LibraryFilterValuesResponse);
  ...
  _createClass(LibraryFilterValuesResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('filter_values')) {
          obj['filter_values'] = _LibraryFilterValues["default"].constructFromObject(data['filter_values']);
        }
...
var _default = LibraryFilterValuesResponse;
