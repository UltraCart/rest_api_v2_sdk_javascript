...
var _EmailPostcardStat = _interopRequireDefault(require("./EmailPostcardStat"));
...
var EmailStatPostcardSummaryResponse = /*#__PURE__*/function () {
  ...
  function EmailStatPostcardSummaryResponse() {
    _classCallCheck(this, EmailStatPostcardSummaryResponse);
  ...
  _createClass(EmailStatPostcardSummaryResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('stats')) {
          obj['stats'] = _ApiClient["default"].convertToType(data['stats'], [_EmailPostcardStat["default"]]);
        }
...
var _default = EmailStatPostcardSummaryResponse;
