...
var _ItemInstantPaymentNotification = _interopRequireDefault(require("./ItemInstantPaymentNotification"));
...
var ItemInstantPaymentNotifications = /*#__PURE__*/function () {
  ...
  function ItemInstantPaymentNotifications() {
    _classCallCheck(this, ItemInstantPaymentNotifications);
  ...
  _createClass(ItemInstantPaymentNotifications, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('notifications')) {
          obj['notifications'] = _ApiClient["default"].convertToType(data['notifications'], [_ItemInstantPaymentNotification["default"]]);
        }
      }
...
var _default = ItemInstantPaymentNotifications;
