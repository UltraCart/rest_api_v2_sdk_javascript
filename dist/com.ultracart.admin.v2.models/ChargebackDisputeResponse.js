...
var ChargebackDisputeResponse = /*#__PURE__*/function () {
  ...
  function ChargebackDisputeResponse() {
    _classCallCheck(this, ChargebackDisputeResponse);
  ...
  _createClass(ChargebackDisputeResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('chargeback')) {
          obj['chargeback'] = _ChargebackDispute["default"].constructFromObject(data['chargeback']);
        }
...
var _default = ChargebackDisputeResponse;
