...
var _ScreenRecordingHeatmapUrl = _interopRequireDefault(require("./ScreenRecordingHeatmapUrl"));
...
var ScreenRecordingHeatmapIndexResponse = /*#__PURE__*/function () {
   ...
   */
  function ScreenRecordingHeatmapIndexResponse() {
    _classCallCheck(this, ScreenRecordingHeatmapIndexResponse);
  ...
  _createClass(ScreenRecordingHeatmapIndexResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('heatmap_urls')) {
          obj['heatmap_urls'] = _ApiClient["default"].convertToType(data['heatmap_urls'], [_ScreenRecordingHeatmapUrl["default"]]);
        }
...
var _default = ScreenRecordingHeatmapIndexResponse;
