...
var EmailCampaignsResponse = /*#__PURE__*/function () {
  ...
  function EmailCampaignsResponse() {
    _classCallCheck(this, EmailCampaignsResponse);
  ...
  _createClass(EmailCampaignsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('campaigns')) {
          obj['campaigns'] = _ApiClient["default"].convertToType(data['campaigns'], [_EmailCampaign["default"]]);
        }
...
var _default = EmailCampaignsResponse;
