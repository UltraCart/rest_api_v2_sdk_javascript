...
var ThumbnailParametersResponse = /*#__PURE__*/function () {
  ...
  function ThumbnailParametersResponse() {
    _classCallCheck(this, ThumbnailParametersResponse);
  ...
  _createClass(ThumbnailParametersResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('thumbnail_url_suffix')) {
          obj['thumbnail_url_suffix'] = _ApiClient["default"].convertToType(data['thumbnail_url_suffix'], 'String');
        }
...
var _default = ThumbnailParametersResponse;
