...
var ItemShipping = /*#__PURE__*/function () {
   ...
   */
  return _createClass(ItemShipping, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('send_to_hold_before_fulfillment')) {
          obj['send_to_hold_before_fulfillment'] = _ApiClient["default"].convertToType(data['send_to_hold_before_fulfillment'], 'Boolean');
        }
...
var _default = exports["default"] = ItemShipping;