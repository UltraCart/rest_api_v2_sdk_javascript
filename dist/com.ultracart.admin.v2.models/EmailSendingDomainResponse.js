...
var EmailSendingDomainResponse = /*#__PURE__*/function () {
  ...
  function EmailSendingDomainResponse() {
    _classCallCheck(this, EmailSendingDomainResponse);
  ...
  _createClass(EmailSendingDomainResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('domain')) {
          obj['domain'] = _EmailDomain["default"].constructFromObject(data['domain']);
        }
...
var _default = EmailSendingDomainResponse;
