 ...
 * @version 4.0.43-RC
 */
var LookupResponse = /*#__PURE__*/function () {
  /**
  ...
  _createClass(LookupResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('values')) {
          obj['values'] = _ApiClient["default"].convertToType(data['values'], [_KeyValue["default"]]);
        }
