...
var OrderItemTag = /*#__PURE__*/function () {
  ...
  function OrderItemTag() {
    _classCallCheck(this, OrderItemTag);
  ...
  _createClass(OrderItemTag, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('tag_value')) {
          obj['tag_value'] = _ApiClient["default"].convertToType(data['tag_value'], 'String');
        }
      }
