...
var _ItemInventorySnapshotDistributionCenter = _interopRequireDefault(require("./ItemInventorySnapshotDistributionCenter"));
 ...
 * @version 4.0.245
 */
var ItemInventorySnapshot = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ItemInventorySnapshot</code>.
   * @alias module:com.ultracart.admin.v2.models/ItemInventorySnapshot
   */
  function ItemInventorySnapshot() {
    _classCallCheck(this, ItemInventorySnapshot);
   ...
   */
  return _createClass(ItemInventorySnapshot, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('distribution_centers')) {
          obj['distribution_centers'] = _ApiClient["default"].convertToType(data['distribution_centers'], [_ItemInventorySnapshotDistributionCenter["default"]]);
        }
...
var _default = exports["default"] = ItemInventorySnapshot;