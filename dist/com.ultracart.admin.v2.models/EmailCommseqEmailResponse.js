...
var _EmailCommseqEmail = _interopRequireDefault(require("./EmailCommseqEmail"));
 ...
 * @version 4.0.98-RC
 */
var EmailCommseqEmailResponse = /*#__PURE__*/function () {
  /**
  ...
  function EmailCommseqEmailResponse() {
    _classCallCheck(this, EmailCommseqEmailResponse);
  ...
  _createClass(EmailCommseqEmailResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('email')) {
          obj['email'] = _EmailCommseqEmail["default"].constructFromObject(data['email']);
        }
...
var _default = EmailCommseqEmailResponse;
