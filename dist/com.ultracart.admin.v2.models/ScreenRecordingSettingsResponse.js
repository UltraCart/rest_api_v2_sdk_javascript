...
var _ScreenRecordingSettings = _interopRequireDefault(require("./ScreenRecordingSettings"));
...
var ScreenRecordingSettingsResponse = /*#__PURE__*/function () {
   ...
   */
  function ScreenRecordingSettingsResponse() {
    _classCallCheck(this, ScreenRecordingSettingsResponse);
  ...
  _createClass(ScreenRecordingSettingsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('settings')) {
          obj['settings'] = _ScreenRecordingSettings["default"].constructFromObject(data['settings']);
        }
...
var _default = ScreenRecordingSettingsResponse;
