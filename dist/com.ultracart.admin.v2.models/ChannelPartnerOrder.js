...
var ChannelPartnerOrder = /*#__PURE__*/function () {
   ...
   */
  return _createClass(ChannelPartnerOrder, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('arbitrary_subtotal_discount')) {
          obj['arbitrary_subtotal_discount'] = _ApiClient["default"].convertToType(data['arbitrary_subtotal_discount'], 'Number');
        }
        ...
        if (data.hasOwnProperty('arbitrary_taxable_subtotal_discount')) {
          obj['arbitrary_taxable_subtotal_discount'] = _ApiClient["default"].convertToType(data['arbitrary_taxable_subtotal_discount'], 'Number');
        }
        ...
        if (data.hasOwnProperty('echeck_bank_aba_code')) {
          obj['echeck_bank_aba_code'] = _ApiClient["default"].convertToType(data['echeck_bank_aba_code'], 'String');
        }
        if (data.hasOwnProperty('echeck_bank_account_name')) {
          obj['echeck_bank_account_name'] = _ApiClient["default"].convertToType(data['echeck_bank_account_name'], 'String');
        }
        if (data.hasOwnProperty('echeck_bank_account_number')) {
          obj['echeck_bank_account_number'] = _ApiClient["default"].convertToType(data['echeck_bank_account_number'], 'String');
        }
        if (data.hasOwnProperty('echeck_bank_account_type')) {
          obj['echeck_bank_account_type'] = _ApiClient["default"].convertToType(data['echeck_bank_account_type'], 'String');
        }
        if (data.hasOwnProperty('echeck_bank_name')) {
          obj['echeck_bank_name'] = _ApiClient["default"].convertToType(data['echeck_bank_name'], 'String');
        }
        if (data.hasOwnProperty('echeck_bank_owner_type')) {
          obj['echeck_bank_owner_type'] = _ApiClient["default"].convertToType(data['echeck_bank_owner_type'], 'String');
        }
        if (data.hasOwnProperty('echeck_customer_tax_id')) {
          obj['echeck_customer_tax_id'] = _ApiClient["default"].convertToType(data['echeck_customer_tax_id'], 'String');
        }
        if (data.hasOwnProperty('echeck_drivers_license_dob')) {
          obj['echeck_drivers_license_dob'] = _ApiClient["default"].convertToType(data['echeck_drivers_license_dob'], 'String');
        }
        if (data.hasOwnProperty('echeck_drivers_license_number')) {
          obj['echeck_drivers_license_number'] = _ApiClient["default"].convertToType(data['echeck_drivers_license_number'], 'String');
        }
        if (data.hasOwnProperty('echeck_drivers_license_state')) {
          obj['echeck_drivers_license_state'] = _ApiClient["default"].convertToType(data['echeck_drivers_license_state'], 'String');
        }
        ...
        if (data.hasOwnProperty('use_prior_payment_information_from_order_id')) {
          obj['use_prior_payment_information_from_order_id'] = _ApiClient["default"].convertToType(data['use_prior_payment_information_from_order_id'], 'String');
        }
      }
      return obj;
    }
 ...
 */
ChannelPartnerOrder.prototype['echeck_bank_aba_code'] = undefined;

/**
 * eCheck bank account name
 * @member {String} echeck_bank_account_name
 */
ChannelPartnerOrder.prototype['echeck_bank_account_name'] = undefined;

/**
 * eCheck bank account number
 * @member {String} echeck_bank_account_number
 */
ChannelPartnerOrder.prototype['echeck_bank_account_number'] = undefined;
 ...
 */
ChannelPartnerOrder.prototype['echeck_bank_account_type'] = undefined;

/**
 * eCheck bank name
 * @member {String} echeck_bank_name
 */
ChannelPartnerOrder.prototype['echeck_bank_name'] = undefined;
 ...
 */
ChannelPartnerOrder.prototype['echeck_bank_owner_type'] = undefined;

/**
 * eCheck customer tax id
 * @member {String} echeck_customer_tax_id
 */
ChannelPartnerOrder.prototype['echeck_customer_tax_id'] = undefined;

/**
 * eCheck drivers license dob
 * @member {String} echeck_drivers_license_dob
 */
ChannelPartnerOrder.prototype['echeck_drivers_license_dob'] = undefined;

/**
 * eCheck drivers license number
 * @member {String} echeck_drivers_license_number
 */
ChannelPartnerOrder.prototype['echeck_drivers_license_number'] = undefined;

/**
 * eCheck drivers license state
 * @member {String} echeck_drivers_license_state
 */
ChannelPartnerOrder.prototype['echeck_drivers_license_state'] = undefined;
 ...
 */
ChannelPartnerOrder.prototype['sales_rep_code'] = undefined;
 ...
 */
ChannelPartnerOrder.prototype['storefront_host_name'] = undefined;
 ...
 * @readonly
 */
ChannelPartnerOrder['EcheckBankAccountTypeEnum'] = {
  /**
   * value: "Checking"
   * @const
   */
 ...
 * @readonly
 */
ChannelPartnerOrder['EcheckBankOwnerTypeEnum'] = {
  /**
   * value: "Business"
   * @const
   */
