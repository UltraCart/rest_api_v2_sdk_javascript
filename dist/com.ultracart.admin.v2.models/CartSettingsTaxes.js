...
var CartSettingsTaxes = /*#__PURE__*/function () {
  ...
  function CartSettingsTaxes() {
    _classCallCheck(this, CartSettingsTaxes);
  ...
  _createClass(CartSettingsTaxes, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('counties')) {
          obj['counties'] = _ApiClient["default"].convertToType(data['counties'], ['String']);
        }
      }
...
var _default = CartSettingsTaxes;
