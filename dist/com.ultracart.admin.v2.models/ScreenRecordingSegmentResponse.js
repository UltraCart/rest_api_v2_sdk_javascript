 ...
 * @version 4.0.169
 */
var ScreenRecordingSegmentResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function ScreenRecordingSegmentResponse() {
    _classCallCheck(this, ScreenRecordingSegmentResponse);
  ...
  _createClass(ScreenRecordingSegmentResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('segment')) {
          obj['segment'] = _ScreenRecordingSegment["default"].constructFromObject(data['segment']);
        }
...
var _default = ScreenRecordingSegmentResponse;
