...
var CouponAutoApplyCondition = /*#__PURE__*/function () {
   ...
   */
  function CouponAutoApplyCondition() {
    _classCallCheck(this, CouponAutoApplyCondition);
  ...
  _createClass(CouponAutoApplyCondition, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('required_item_id')) {
          obj['required_item_id'] = _ApiClient["default"].convertToType(data['required_item_id'], 'String');
        }
      }
  ...
  return CouponAutoApplyCondition;
}();
/**
...
var _default = CouponAutoApplyCondition;
