...
var CartUpsellAfter = /*#__PURE__*/function () {
   ...
   */
  return _createClass(CartUpsellAfter, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('upsell_path_name')) {
          obj['upsell_path_name'] = _ApiClient["default"].convertToType(data['upsell_path_name'], 'String');
        }
        if (data.hasOwnProperty('upsell_path_variation')) {
          obj['upsell_path_variation'] = _ApiClient["default"].convertToType(data['upsell_path_variation'], 'String');
        }
      }
      return obj;
    }
...
var _default = exports["default"] = CartUpsellAfter;