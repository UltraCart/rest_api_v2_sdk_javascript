...
var SfvbPreviewAccessResponse = /*#__PURE__*/function () {
   ...
   */
  function SfvbPreviewAccessResponse() {
    _classCallCheck(this, SfvbPreviewAccessResponse);
   ...
   */
  return _createClass(SfvbPreviewAccessResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('access_url')) {
          obj['access_url'] = _ApiClient["default"].convertToType(data['access_url'], 'String');
        }
        ...
        if (data.hasOwnProperty('session_lifetime_seconds')) {
          obj['session_lifetime_seconds'] = _ApiClient["default"].convertToType(data['session_lifetime_seconds'], 'Number');
        }
        if (data.hasOwnProperty('single_use')) {
          obj['single_use'] = _ApiClient["default"].convertToType(data['single_use'], 'Boolean');
        }
...
var _default = exports["default"] = SfvbPreviewAccessResponse;