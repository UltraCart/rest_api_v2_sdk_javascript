...
var _EmailGlobalSettings = _interopRequireDefault(require("./EmailGlobalSettings"));
...
var EmailGlobalSettingsResponse = /*#__PURE__*/function () {
  ...
  function EmailGlobalSettingsResponse() {
    _classCallCheck(this, EmailGlobalSettingsResponse);

    EmailGlobalSettingsResponse.initialize(this);
  }
  /**
  ...
  _createClass(EmailGlobalSettingsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new EmailGlobalSettingsResponse();
        ...
        if (data.hasOwnProperty('global_settings')) {
          obj['global_settings'] = _EmailGlobalSettings["default"].constructFromObject(data['global_settings']);
        }
...
EmailGlobalSettingsResponse.prototype['error'] = undefined;
/**
 * @member {module:com.ultracart.admin.v2.models/EmailGlobalSettings} global_settings
 */

EmailGlobalSettingsResponse.prototype['global_settings'] = undefined;
/**
 * @member {module:com.ultracart.admin.v2.models/ResponseMetadata} metadata
 */

EmailGlobalSettingsResponse.prototype['metadata'] = undefined;
/**
 * Indicates if API call was successful
 * @member {Boolean} success
 */

EmailGlobalSettingsResponse.prototype['success'] = undefined;
/**
 * @member {module:com.ultracart.admin.v2.models/Warning} warning
 */

EmailGlobalSettingsResponse.prototype['warning'] = undefined;
var _default = EmailGlobalSettingsResponse;
