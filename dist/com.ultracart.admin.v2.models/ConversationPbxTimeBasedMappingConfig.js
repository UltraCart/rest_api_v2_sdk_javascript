...
var _ConversationPbxTimeBasedMapping = _interopRequireDefault(require("./ConversationPbxTimeBasedMapping"));
 ...
 * @version 4.1.43
 */
var ConversationPbxTimeBasedMappingConfig = /*#__PURE__*/function () {
  /**
   ...
   */
  function ConversationPbxTimeBasedMappingConfig() {
    _classCallCheck(this, ConversationPbxTimeBasedMappingConfig);
   ...
   */
  return _createClass(ConversationPbxTimeBasedMappingConfig, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('default_mapping')) {
          obj['default_mapping'] = _ConversationPbxTimeBasedMapping["default"].constructFromObject(data['default_mapping']);
        }
        if (data.hasOwnProperty('mappings')) {
          obj['mappings'] = _ApiClient["default"].convertToType(data['mappings'], [_ConversationPbxTimeBasedMapping["default"]]);
        }
      }
      return obj;
    }
...
var _default = exports["default"] = ConversationPbxTimeBasedMappingConfig;