 ...
 * @version 4.0.155
 */
var CartPaymentAmazon = /*#__PURE__*/function () {
  /**
  ...
  function CartPaymentAmazon() {
    _classCallCheck(this, CartPaymentAmazon);
  ...
  _createClass(CartPaymentAmazon, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('amazon_order_reference_id')) {
          obj['amazon_order_reference_id'] = _ApiClient["default"].convertToType(data['amazon_order_reference_id'], 'String');
        }
      }
...
var _default = CartPaymentAmazon;
