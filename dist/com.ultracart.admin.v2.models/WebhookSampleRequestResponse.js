...
var _WebhookSampleRequest = _interopRequireDefault(require("./WebhookSampleRequest"));
 ...
 * @version 4.0.54-RC
 */
var WebhookSampleRequestResponse = /*#__PURE__*/function () {
  /**
  ...
  function WebhookSampleRequestResponse() {
    _classCallCheck(this, WebhookSampleRequestResponse);
  ...
  _createClass(WebhookSampleRequestResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('webhook_sample_request')) {
          obj['webhook_sample_request'] = _WebhookSampleRequest["default"].constructFromObject(data['webhook_sample_request']);
        }
      }
...
var _default = WebhookSampleRequestResponse;
