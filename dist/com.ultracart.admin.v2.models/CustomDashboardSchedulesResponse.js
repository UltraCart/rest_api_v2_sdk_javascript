...
var CustomDashboardSchedulesResponse = /*#__PURE__*/function () {
   ...
   */
  function CustomDashboardSchedulesResponse() {
    _classCallCheck(this, CustomDashboardSchedulesResponse);
   ...
   */
  return _createClass(CustomDashboardSchedulesResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('schedules')) {
          obj['schedules'] = _ApiClient["default"].convertToType(data['schedules'], [_CustomDashboardSchedule["default"]]);
        }
...
var _default = exports["default"] = CustomDashboardSchedulesResponse;