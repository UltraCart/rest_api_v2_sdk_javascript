...
var _CouponTierQuantityAmount = _interopRequireDefault(require("./CouponTierQuantityAmount"));
...
var CouponTieredAmountOffItems = /*#__PURE__*/function () {
   ...
   */
  function CouponTieredAmountOffItems() {
    _classCallCheck(this, CouponTieredAmountOffItems);
  ...
  _createClass(CouponTieredAmountOffItems, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('tiers')) {
          obj['tiers'] = _ApiClient["default"].convertToType(data['tiers'], [_CouponTierQuantityAmount["default"]]);
        }
      }
...
var _default = CouponTieredAmountOffItems;
