 ...
 * @version 4.1.7
 */
var ConversationPbxQueueResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function ConversationPbxQueueResponse() {
    _classCallCheck(this, ConversationPbxQueueResponse);
   ...
   */
  return _createClass(ConversationPbxQueueResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('queue')) {
          obj['queue'] = _ConversationPbxQueue["default"].constructFromObject(data['queue']);
        }
...
var _default = exports["default"] = ConversationPbxQueueResponse;