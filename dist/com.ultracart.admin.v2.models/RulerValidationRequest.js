...
var RulerValidationRequest = /*#__PURE__*/function () {
   ...
   */
  function RulerValidationRequest() {
    _classCallCheck(this, RulerValidationRequest);
  ...
  _createClass(RulerValidationRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('ruler')) {
          obj['ruler'] = _ApiClient["default"].convertToType(data['ruler'], 'String');
        }
      }
...
var _default = RulerValidationRequest;
