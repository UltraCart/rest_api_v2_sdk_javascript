...
*UltraCartRestApiV2.CustomerApi* | [**getEmailLists**](docs/CustomerApi.md#getEmailLists) | **GET** /customer/email_lists | Retrieve all email lists across all storefronts
...
*UltraCartRestApiV2.StorefrontApi* | [**getPricingTiers**](docs/StorefrontApi.md#getPricingTiers) | **GET** /storefront/pricing_tiers | Retrieve pricing tiers
