...
*UltraCartRestApiV2.OrderApi* | [**blockRefundOnOrder**](docs/OrderApi.md#blockRefundOnOrder) | **POST** /order/orders/{order_id}/refund_block | Set a refund block on an order
...
*UltraCartRestApiV2.OrderApi* | [**refundOrderCompletely**](docs/OrderApi.md#refundOrderCompletely) | **PUT** /order/orders/{order_id}/refund_completely | Refund an order completely
...
*UltraCartRestApiV2.OrderApi* | [**unblockRefundOnOrder**](docs/OrderApi.md#unblockRefundOnOrder) | **POST** /order/orders/{order_id}/refund_unblock | Remove a refund block on an order
