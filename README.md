...
*UltraCartRestApiV2.ItemApi* | [**getItemShippingDistributionCenterByCode**](docs/ItemApi.md#getItemShippingDistributionCenterByCode) | **GET** /item/items/{merchant_item_oid}/shipping/distribution_centers/by_code/{distribution_center_code} | Retrieve an item shipping distribution center
...
*UltraCartRestApiV2.ItemApi* | [**updateItemInventories**](docs/ItemApi.md#updateItemInventories) | **PUT** /item/items/update_item_inventories | Update item inventories for a distribution center
*UltraCartRestApiV2.ItemApi* | [**updateItemShippingDistributionCenterByCode**](docs/ItemApi.md#updateItemShippingDistributionCenterByCode) | **PUT** /item/items/{merchant_item_oid}/shipping/distribution_centers/by_code/{distribution_center_code} | Update an item shipping distribution center
...
## Documentation for Models
 ...
 - [UltraCartRestApiV2.ItemInventoryUpdate](docs/ItemInventoryUpdate.md)
 - [UltraCartRestApiV2.ItemInventoryUpdateRequest](docs/ItemInventoryUpdateRequest.md)
 ...
 - [UltraCartRestApiV2.ItemShippingDistributionCenterResponse](docs/ItemShippingDistributionCenterResponse.md)
