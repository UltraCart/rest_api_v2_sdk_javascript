...
*UltraCartRestApiV2.StorefrontApi* | [**cloneLibraryItem**](docs/StorefrontApi.md#cloneLibraryItem) | **POST** /storefront/code_library/{library_item_oid}/clone | Clone public library item.
