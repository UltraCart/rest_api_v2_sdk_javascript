...
*UltraCartRestApiV2.ItemApi* | [**restItemInventorySnapshotResponse**](docs/ItemApi.md#restItemInventorySnapshotResponse) | **GET** /item/items/inventory_snapshot | Retrieve a list of item inventories
