...
*UltraCartRestApiV2.StorefrontApi* | [**getEmailListCustomerEditorUrl**](docs/StorefrontApi.md#getEmailListCustomerEditorUrl) | **GET** /storefront/{storefront_oid}/email/lists/{email_list_uuid}/customers/{email_customer_uuid}/editor_url | Get email list customers
