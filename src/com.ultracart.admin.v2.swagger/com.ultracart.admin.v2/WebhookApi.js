...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['com.ultracart.admin.v2.swagger/ApiClient', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ErrorResponse', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/WebhookLogResponse', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/WebhookLogSummariesResponse', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/WebhooksResponse', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/WebhookResponse', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Webhook', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/WebhookSampleRequestResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../com.ultracart.admin.v2.models/ErrorResponse'), require('../com.ultracart.admin.v2.models/WebhookLogResponse'), require('../com.ultracart.admin.v2.models/WebhookLogSummariesResponse'), require('../com.ultracart.admin.v2.models/WebhooksResponse'), require('../com.ultracart.admin.v2.models/WebhookResponse'), require('../com.ultracart.admin.v2.models/Webhook'), require('../com.ultracart.admin.v2.models/WebhookSampleRequestResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.UltraCartRestApiV2) {
      root.UltraCartRestApiV2 = {};
    }
    root.UltraCartRestApiV2.WebhookApi = factory(root.UltraCartRestApiV2.ApiClient, root.UltraCartRestApiV2.ErrorResponse, root.UltraCartRestApiV2.WebhookLogResponse, root.UltraCartRestApiV2.WebhookLogSummariesResponse, root.UltraCartRestApiV2.WebhooksResponse, root.UltraCartRestApiV2.WebhookResponse, root.UltraCartRestApiV2.Webhook, root.UltraCartRestApiV2.WebhookSampleRequestResponse);
  }
}(this, function(ApiClient, ErrorResponse, WebhookLogResponse, WebhookLogSummariesResponse, WebhooksResponse, WebhookResponse, Webhook, WebhookSampleRequestResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2/WebhookApi~deleteWebhookCallback
     ...
     * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2/WebhookApi~deleteWebhookCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.deleteWebhook = function(webhookOid, callback) {
      ...
      if (webhookOid == undefined || webhookOid == null) {
        throw "Missing the required parameter 'webhookOid' when calling deleteWebhook";
      }
     ...
     * @callback module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2/WebhookApi~getWebhookLogCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2/WebhookApi~getWebhookLogCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    this.getWebhookLog = function(webhookOid, requestId, callback) {
      ...
      // verify the required parameter 'webhookOid' is set
      if (webhookOid == undefined || webhookOid == null) {
        throw "Missing the required parameter 'webhookOid' when calling getWebhookLog";
      }

      // verify the required parameter 'requestId' is set
      if (requestId == undefined || requestId == null) {
        throw "Missing the required parameter 'requestId' when calling getWebhookLog";
      }
     ...
     * @callback module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2/WebhookApi~getWebhookLogSummariesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2/WebhookApi~getWebhookLogSummariesCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    this.getWebhookLogSummaries = function(webhookOid, opts, callback) {
      ...
      // verify the required parameter 'webhookOid' is set
      if (webhookOid == undefined || webhookOid == null) {
        throw "Missing the required parameter 'webhookOid' when calling getWebhookLogSummaries";
      }
     ...
     * @callback module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2/WebhookApi~getWebhooksCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2/WebhookApi~getWebhooksCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2/WebhookApi~insertWebhookCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {Boolean} opts.placeholders Whether or not placeholder values should be returned in the result.  Useful for UIs that consume this REST API.
     * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2/WebhookApi~insertWebhookCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    this.insertWebhook = function(webhook, opts, callback) {
      ...
      if (webhook == undefined || webhook == null) {
        throw "Missing the required parameter 'webhook' when calling insertWebhook";
      }
     ...
     * @callback module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2/WebhookApi~resendEventCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2/WebhookApi~resendEventCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    this.resendEvent = function(webhookOid, eventName, callback) {
      ...
      // verify the required parameter 'webhookOid' is set
      if (webhookOid == undefined || webhookOid == null) {
        throw "Missing the required parameter 'webhookOid' when calling resendEvent";
      }

      // verify the required parameter 'eventName' is set
      if (eventName == undefined || eventName == null) {
        throw "Missing the required parameter 'eventName' when calling resendEvent";
      }
     ...
     * @callback module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2/WebhookApi~updateWebhookCallback
     * @param {String} error Error message, if any.
     * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/WebhookResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Boolean} opts.placeholders Whether or not placeholder values should be returned in the result.  Useful for UIs that consume this REST API.
     * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2/WebhookApi~updateWebhookCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/WebhookResponse}
     */
    this.updateWebhook = function(webhook, webhookOid, opts, callback) {
      ...
      // verify the required parameter 'webhook' is set
      if (webhook == undefined || webhook == null) {
        throw "Missing the required parameter 'webhook' when calling updateWebhook";
      }

      // verify the required parameter 'webhookOid' is set
      if (webhookOid == undefined || webhookOid == null) {
        throw "Missing the required parameter 'webhookOid' when calling updateWebhook";
      }
