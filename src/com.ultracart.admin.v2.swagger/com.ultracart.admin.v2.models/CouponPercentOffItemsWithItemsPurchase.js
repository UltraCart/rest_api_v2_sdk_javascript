...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponPercentOffItemsWithItemsPurchase
   * @version 2.0.4
   */

  /**
   * Constructs a new <code>CouponPercentOffItemsWithItemsPurchase</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponPercentOffItemsWithItemsPurchase
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponPercentOffItemsWithItemsPurchase} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponPercentOffItemsWithItemsPurchase} The populated <code>CouponPercentOffItemsWithItemsPurchase</code> instance.
   */
