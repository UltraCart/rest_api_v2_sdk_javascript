...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['com.ultracart.admin.v2.swagger/ApiClient', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartCustomerProfileAddress', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartCustomerProfileCreditCard'], factory);
   ...
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartCustomerProfile
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartCustomerProfile} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartCustomerProfile} The populated <code>CartCustomerProfile</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('maximum_item_count')) {
        obj['maximum_item_count'] = ApiClient.convertToType(data['maximum_item_count'], 'Integer');
      }
      if (data.hasOwnProperty('minimum_item_count')) {
        obj['minimum_item_count'] = ApiClient.convertToType(data['minimum_item_count'], 'Integer');
      }
   ...
   * @member {Array.<module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartCustomerProfileAddress>} billing_addresses
   */
  exports.prototype['billing_addresses'] = undefined;
  /**
   * Credit cards on file for this profile (masked)
   * @member {Array.<module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartCustomerProfileCreditCard>} credit_cards
   */
   ...
   * @member {Array.<module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartCustomerProfileAddress>} shipping_addresses
   */
