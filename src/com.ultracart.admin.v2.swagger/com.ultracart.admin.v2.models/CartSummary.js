...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSummary
   * @version 2.0.8
   */

  /**
   * Constructs a new <code>CartSummary</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSummary
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSummary} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSummary} The populated <code>CartSummary</code> instance.
   */
  ...
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Currency} arbitrary_shipping_handling_total
   */
  exports.prototype['arbitrary_shipping_handling_total'] = undefined;
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Currency} arbitrary_tax
   */
  exports.prototype['arbitrary_tax'] = undefined;
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Currency} arbitrary_tax_rate
   */
  exports.prototype['arbitrary_tax_rate'] = undefined;
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Currency} arbitrary_taxable_subtotal
   */
  exports.prototype['arbitrary_taxable_subtotal'] = undefined;
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Currency} shipping_handling
   */
  exports.prototype['shipping_handling'] = undefined;
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Currency} shipping_handling_discount
   */
  exports.prototype['shipping_handling_discount'] = undefined;
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Currency} shipping_handling_with_discount
   */
  ...
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Currency} subtotal_with_discount
   */
  ...
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Currency} taxable_subtotal_with_discount
   */
