...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemEmailNotifications
   * @version 2.0.5
   */

  /**
   * Constructs a new <code>ItemEmailNotifications</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemEmailNotifications
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemEmailNotifications} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemEmailNotifications} The populated <code>ItemEmailNotifications</code> instance.
   */
