...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderItemEdiLot
   * @version 2.0.9
   */

  /**
   * Constructs a new <code>OrderItemEdiLot</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderItemEdiLot
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderItemEdiLot} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderItemEdiLot} The populated <code>OrderItemEdiLot</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('lot_quantity')) {
        obj['lot_quantity'] = ApiClient.convertToType(data['lot_quantity'], 'Integer');
      }
    }
    return obj;
  }
