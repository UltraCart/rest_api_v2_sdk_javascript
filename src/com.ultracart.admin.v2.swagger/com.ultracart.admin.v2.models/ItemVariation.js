...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['com.ultracart.admin.v2.swagger/ApiClient', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemVariationOption'], factory);
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemVariation
   * @version 2.0.9
   */

  /**
   * Constructs a new <code>ItemVariation</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemVariation
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemVariation} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemVariation} The populated <code>ItemVariation</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('default_text_translated_text_instance_oid')) {
        obj['default_text_translated_text_instance_oid'] = ApiClient.convertToType(data['default_text_translated_text_instance_oid'], 'Integer');
      }
      if (data.hasOwnProperty('name')) {
        obj['name'] = ApiClient.convertToType(data['name'], 'String');
      }
      if (data.hasOwnProperty('name_translated_text_instance_oid')) {
        obj['name_translated_text_instance_oid'] = ApiClient.convertToType(data['name_translated_text_instance_oid'], 'Integer');
      }
