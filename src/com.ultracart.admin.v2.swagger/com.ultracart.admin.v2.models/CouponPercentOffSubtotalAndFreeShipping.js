...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponPercentOffSubtotalAndFreeShipping
   * @version 2.0.5
   */

  /**
   * Constructs a new <code>CouponPercentOffSubtotalAndFreeShipping</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponPercentOffSubtotalAndFreeShipping
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponPercentOffSubtotalAndFreeShipping} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponPercentOffSubtotalAndFreeShipping} The populated <code>CouponPercentOffSubtotalAndFreeShipping</code> instance.
   */
