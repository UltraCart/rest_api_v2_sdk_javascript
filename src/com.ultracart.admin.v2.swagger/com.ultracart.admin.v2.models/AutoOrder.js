...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('cancel_after_next_x_orders')) {
        obj['cancel_after_next_x_orders'] = ApiClient.convertToType(data['cancel_after_next_x_orders'], 'Integer');
      }
      ...
      if (data.hasOwnProperty('credit_card_attempt')) {
        obj['credit_card_attempt'] = ApiClient.convertToType(data['credit_card_attempt'], 'Integer');
      }
      ...
      if (data.hasOwnProperty('override_affiliate_id')) {
        obj['override_affiliate_id'] = ApiClient.convertToType(data['override_affiliate_id'], 'Integer');
      }
   ...
   * @member {Integer} cancel_after_next_x_orders
   */
   ...
   * @member {Integer} credit_card_attempt
   */
   ...
   * @member {Integer} override_affiliate_id
   */
