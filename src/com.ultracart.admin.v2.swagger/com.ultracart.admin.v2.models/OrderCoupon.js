...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderCoupon
   * @version 2.0.3
   */

  /**
   * Constructs a new <code>OrderCoupon</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderCoupon
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderCoupon} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderCoupon} The populated <code>OrderCoupon</code> instance.
   */
