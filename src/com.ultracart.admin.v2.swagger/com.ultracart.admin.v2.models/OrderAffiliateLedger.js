...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderAffiliateLedger
   * @version 2.0.8
   */

  /**
   * Constructs a new <code>OrderAffiliateLedger</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderAffiliateLedger
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderAffiliateLedger} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderAffiliateLedger} The populated <code>OrderAffiliateLedger</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('tier_number')) {
        obj['tier_number'] = ApiClient.convertToType(data['tier_number'], 'Integer');
      }
   ...
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderAffiliateLedger.TransactionStateEnum} transaction_state
   */
