...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponPercentOffItemWithItemsQuantityPurchase
   * @version 2.1.0
   */

  /**
   * Constructs a new <code>CouponPercentOffItemWithItemsQuantityPurchase</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponPercentOffItemWithItemsQuantityPurchase
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponPercentOffItemWithItemsQuantityPurchase} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponPercentOffItemWithItemsQuantityPurchase} The populated <code>CouponPercentOffItemWithItemsQuantityPurchase</code> instance.
   */
