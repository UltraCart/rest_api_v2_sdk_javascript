...
(function(root, factory) {
   ...
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Customer
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Customer} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Customer} The populated <code>Customer</code> instance.
   */
   ...
   * @member {Array.<module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CustomerBilling>} billing
   */
   ...
   * @member {Array.<module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CustomerPricingTier>} pricing_tiers
   */
   ...
   * @member {Array.<module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CustomerShipping>} shipping
   */
