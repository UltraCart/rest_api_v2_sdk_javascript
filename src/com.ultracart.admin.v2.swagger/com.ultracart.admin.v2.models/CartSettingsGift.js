...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['com.ultracart.admin.v2.swagger/ApiClient', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsGiftWrap', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Currency'], factory);
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsGift
   * @version 2.0.7
   */

  /**
   * Constructs a new <code>CartSettingsGift</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsGift
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsGift} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsGift} The populated <code>CartSettingsGift</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('max_message_length')) {
        obj['max_message_length'] = ApiClient.convertToType(data['max_message_length'], 'Integer');
      }
    }
    return obj;
  }
   ...
   * @member {Array.<module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsGiftWrap>} gift_wraps
   */
  exports.prototype['gift_wraps'] = undefined;
  /**
   * The maximum length of the gift message the giver can enter
   * @member {Integer} max_message_length
   */
