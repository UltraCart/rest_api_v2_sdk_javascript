...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CustomerBilling
   * @version 2.0.4
   */

  /**
   * Constructs a new <code>CustomerBilling</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CustomerBilling
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CustomerBilling} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CustomerBilling} The populated <code>CustomerBilling</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('customer_billing_oid')) {
        obj['customer_billing_oid'] = ApiClient.convertToType(data['customer_billing_oid'], 'Integer');
      }
   ...
   * @member {Integer} customer_billing_oid
   */
