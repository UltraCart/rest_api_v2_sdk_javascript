...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartUpsellAfter
   * @version 2.0.6
   */

  /**
   * Constructs a new <code>CartUpsellAfter</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartUpsellAfter
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartUpsellAfter} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartUpsellAfter} The populated <code>CartUpsellAfter</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('finalize_after_minutes')) {
        obj['finalize_after_minutes'] = ApiClient.convertToType(data['finalize_after_minutes'], 'Integer');
      }
   ...
   * @member {Integer} finalize_after_minutes
   */
