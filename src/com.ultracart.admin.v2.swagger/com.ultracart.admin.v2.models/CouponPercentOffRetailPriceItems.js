...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponPercentOffRetailPriceItems
   * @version 2.0.3
   */

  /**
   * Constructs a new <code>CouponPercentOffRetailPriceItems</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponPercentOffRetailPriceItems
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponPercentOffRetailPriceItems} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponPercentOffRetailPriceItems} The populated <code>CouponPercentOffRetailPriceItems</code> instance.
   */
