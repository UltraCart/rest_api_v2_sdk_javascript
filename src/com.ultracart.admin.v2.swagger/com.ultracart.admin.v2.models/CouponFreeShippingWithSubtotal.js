...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponFreeShippingWithSubtotal
   * @version 2.0.7
   */

  /**
   * Constructs a new <code>CouponFreeShippingWithSubtotal</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponFreeShippingWithSubtotal
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponFreeShippingWithSubtotal} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponFreeShippingWithSubtotal} The populated <code>CouponFreeShippingWithSubtotal</code> instance.
   */
