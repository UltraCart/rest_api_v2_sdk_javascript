...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponFreeShippingWithItemsPurchase
   * @version 2.0.8
   */

  /**
   * Constructs a new <code>CouponFreeShippingWithItemsPurchase</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponFreeShippingWithItemsPurchase
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponFreeShippingWithItemsPurchase} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponFreeShippingWithItemsPurchase} The populated <code>CouponFreeShippingWithItemsPurchase</code> instance.
   */
