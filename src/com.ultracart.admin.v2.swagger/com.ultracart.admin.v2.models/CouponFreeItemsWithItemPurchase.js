...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponFreeItemsWithItemPurchase
   * @version 2.1.0
   */

  /**
   * Constructs a new <code>CouponFreeItemsWithItemPurchase</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponFreeItemsWithItemPurchase
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponFreeItemsWithItemPurchase} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponFreeItemsWithItemPurchase} The populated <code>CouponFreeItemsWithItemPurchase</code> instance.
   */
