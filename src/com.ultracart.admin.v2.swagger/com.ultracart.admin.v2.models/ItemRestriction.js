...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['com.ultracart.admin.v2.swagger/ApiClient', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemRestrictionItem'], factory);
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemRestriction
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>ItemRestriction</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemRestriction
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemRestriction} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemRestriction} The populated <code>ItemRestriction</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('maximum_quantity')) {
        obj['maximum_quantity'] = ApiClient.convertToType(data['maximum_quantity'], 'Integer');
      }
      if (data.hasOwnProperty('minimum_quantity')) {
        obj['minimum_quantity'] = ApiClient.convertToType(data['minimum_quantity'], 'Integer');
      }
