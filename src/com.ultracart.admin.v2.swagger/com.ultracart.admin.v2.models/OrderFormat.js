  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('filter_distribution_center_oid')) {
        obj['filter_distribution_center_oid'] = ApiClient.convertToType(data['filter_distribution_center_oid'], 'Integer');
      }
      if (data.hasOwnProperty('filter_to_items_in_contact_oid')) {
        obj['filter_to_items_in_contact_oid'] = ApiClient.convertToType(data['filter_to_items_in_contact_oid'], 'Integer');
      }
