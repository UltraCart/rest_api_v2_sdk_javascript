...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['com.ultracart.admin.v2.swagger/ApiClient', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/WebhookEventSubscription'], factory);
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/WebhookEventCategory
   * @version 2.0.8
   */

  /**
   * Constructs a new <code>WebhookEventCategory</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/WebhookEventCategory
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/WebhookEventCategory} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/WebhookEventCategory} The populated <code>WebhookEventCategory</code> instance.
   */
