...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['com.ultracart.admin.v2.swagger/ApiClient', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsProvince', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsShippingCalendar', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsShippingEstimate'], factory);
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsShipping
   * @version 2.0.4
   */

  /**
   * Constructs a new <code>CartSettingsShipping</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsShipping
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsShipping} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsShipping} The populated <code>CartSettingsShipping</code> instance.
   */
  ...
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsShippingCalendar} deliver_on_date
   */
  exports.prototype['deliver_on_date'] = undefined;
  /**
   * Estimates for this cart
   * @member {Array.<module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsShippingEstimate>} estimates
   */
  ...
  /**
   * Provinces
   * @member {Array.<module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsProvince>} provinces
   */
  exports.prototype['provinces'] = undefined;
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsShippingCalendar} ship_on_date
   */
