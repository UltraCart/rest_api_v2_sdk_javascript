...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemShippingDestinationMarkup
   * @version 2.0.2
   */

  /**
   * Constructs a new <code>ItemShippingDestinationMarkup</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemShippingDestinationMarkup
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemShippingDestinationMarkup} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemShippingDestinationMarkup} The populated <code>ItemShippingDestinationMarkup</code> instance.
   */
