...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponFreeItemAndShippingWithSubtotal
   * @version 2.0.3
   */

  /**
   * Constructs a new <code>CouponFreeItemAndShippingWithSubtotal</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponFreeItemAndShippingWithSubtotal
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponFreeItemAndShippingWithSubtotal} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponFreeItemAndShippingWithSubtotal} The populated <code>CouponFreeItemAndShippingWithSubtotal</code> instance.
   */
