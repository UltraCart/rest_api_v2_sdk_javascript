...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponPercentOffItemsAndFreeShipping
   * @version 2.0.9
   */

  /**
   * Constructs a new <code>CouponPercentOffItemsAndFreeShipping</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponPercentOffItemsAndFreeShipping
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponPercentOffItemsAndFreeShipping} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponPercentOffItemsAndFreeShipping} The populated <code>CouponPercentOffItemsAndFreeShipping</code> instance.
   */
