...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemGoogleProductSearch
   * @version 2.0.3
   */

  /**
   * Constructs a new <code>ItemGoogleProductSearch</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemGoogleProductSearch
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemGoogleProductSearch} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemGoogleProductSearch} The populated <code>ItemGoogleProductSearch</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('search_position')) {
        obj['search_position'] = ApiClient.convertToType(data['search_position'], 'Integer');
      }
