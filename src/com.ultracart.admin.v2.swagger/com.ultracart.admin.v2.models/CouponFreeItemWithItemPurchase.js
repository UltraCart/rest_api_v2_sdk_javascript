...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponFreeItemWithItemPurchase
   * @version 2.0.4
   */

  /**
   * Constructs a new <code>CouponFreeItemWithItemPurchase</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponFreeItemWithItemPurchase
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponFreeItemWithItemPurchase} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponFreeItemWithItemPurchase} The populated <code>CouponFreeItemWithItemPurchase</code> instance.
   */
