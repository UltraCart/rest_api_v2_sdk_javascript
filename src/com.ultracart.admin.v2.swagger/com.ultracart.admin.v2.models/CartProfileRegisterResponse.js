...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartProfileRegisterResponse
   * @version 2.0.7
   */

  /**
   * Constructs a new <code>CartProfileRegisterResponse</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartProfileRegisterResponse
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartProfileRegisterResponse} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartProfileRegisterResponse} The populated <code>CartProfileRegisterResponse</code> instance.
   */
