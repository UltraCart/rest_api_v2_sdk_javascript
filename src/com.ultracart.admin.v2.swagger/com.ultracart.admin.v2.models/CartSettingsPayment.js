...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['com.ultracart.admin.v2.swagger/ApiClient', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsPaymentAmazon', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsPaymentCreditCard', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsPaymentPayPal'], factory);
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsPayment
   * @version 2.0.7
   */

  /**
   * Constructs a new <code>CartSettingsPayment</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsPayment
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsPayment} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsPayment} The populated <code>CartSettingsPayment</code> instance.
   */
  ...
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsPaymentAmazon} amazon
   */
  exports.prototype['amazon'] = undefined;
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsPaymentCreditCard} credit_card
   */
  ...
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsPaymentPayPal} paypal
   */
