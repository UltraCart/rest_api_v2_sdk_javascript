...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['com.ultracart.admin.v2.swagger/ApiClient', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/AutoOrderItemOption'], factory);
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/AutoOrderItem
   * @version 2.0.4
   */

  /**
   * Constructs a new <code>AutoOrderItem</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/AutoOrderItem
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/AutoOrderItem} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/AutoOrderItem} The populated <code>AutoOrderItem</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('number_of_rebills')) {
        obj['number_of_rebills'] = ApiClient.convertToType(data['number_of_rebills'], 'Integer');
      }
      ...
      if (data.hasOwnProperty('remaining_repeat_count')) {
        obj['remaining_repeat_count'] = ApiClient.convertToType(data['remaining_repeat_count'], 'Integer');
      }
    }
    return obj;
  }
   ...
   * @member {Integer} number_of_rebills
   */
  exports.prototype['number_of_rebills'] = undefined;
  /**
   * Options associated with this item
   * @member {Array.<module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/AutoOrderItemOption>} options
   */
   ...
   * @member {Integer} remaining_repeat_count
   */
