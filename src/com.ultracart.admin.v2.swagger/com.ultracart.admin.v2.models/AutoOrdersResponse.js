...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/AutoOrdersResponse
   * @version 2.0.4
   */

  /**
   * Constructs a new <code>AutoOrdersResponse</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/AutoOrdersResponse
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/AutoOrdersResponse} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/AutoOrdersResponse} The populated <code>AutoOrdersResponse</code> instance.
   */
  ...
  /**
   * @member {Array.<module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/AutoOrder>} auto_orders
   */
