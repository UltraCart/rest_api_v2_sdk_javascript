...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['com.ultracart.admin.v2.swagger/ApiClient', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Distance', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemOptionValueAdditionalItem', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemOptionValueDigitalItem', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Weight'], factory);
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemOptionValue
   * @version 2.0.8
   */

  /**
   * Constructs a new <code>ItemOptionValue</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemOptionValue
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemOptionValue} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemOptionValue} The populated <code>ItemOptionValue</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('option_value_oid')) {
        obj['option_value_oid'] = ApiClient.convertToType(data['option_value_oid'], 'Integer');
      }
      ...
      if (data.hasOwnProperty('translated_text_instance_oid')) {
        obj['translated_text_instance_oid'] = ApiClient.convertToType(data['translated_text_instance_oid'], 'Integer');
      }
   ...
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemOptionValue.AdditionalDimensionApplicationEnum} additional_dimension_application
   */
   ...
   * @member {Array.<module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemOptionValueAdditionalItem>} additional_items
   */
   ...
   * @member {Array.<module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemOptionValueDigitalItem>} digital_items
   */
  exports.prototype['digital_items'] = undefined;
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Distance} height
   */
  exports.prototype['height'] = undefined;
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Distance} length
   */
   ...
   * @member {Integer} option_value_oid
   */
  ...
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Weight} weight_change
   */
  ...
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Distance} width
   */
