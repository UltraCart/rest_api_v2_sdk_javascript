...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['com.ultracart.admin.v2.swagger/ApiClient', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Error', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Order', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ResponseMetadata'], factory);
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderResponse
   * @version 2.0.6
   */

  /**
   * Constructs a new <code>OrderResponse</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderResponse
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderResponse} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderResponse} The populated <code>OrderResponse</code> instance.
   */
