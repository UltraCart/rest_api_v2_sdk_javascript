...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['com.ultracart.admin.v2.swagger/ApiClient', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Currency', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderPaymentCheck', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderPaymentCreditCard', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderPaymentECheck', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderPaymentPurchaseOrder', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderPaymentTransaction'], factory);
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderPayment
   * @version 2.0.8
   */

  /**
   * Constructs a new <code>OrderPayment</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderPayment
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderPayment} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderPayment} The populated <code>OrderPayment</code> instance.
   */
  ...
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderPaymentCheck} check
   */
  exports.prototype['check'] = undefined;
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderPaymentCreditCard} credit_card
   */
  exports.prototype['credit_card'] = undefined;
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderPaymentECheck} echeck
   */
  ...
  /**
   * Payment method
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderPayment.PaymentMethodEnum} payment_method
   */
  ...
  /**
   * Payment status
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderPayment.PaymentStatusEnum} payment_status
   */
  exports.prototype['payment_status'] = undefined;
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderPaymentPurchaseOrder} purchase_order
   */
  ...
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Currency} surcharge
   */
   ...
   * @member {Array.<module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderPaymentTransaction>} transactions
   */
