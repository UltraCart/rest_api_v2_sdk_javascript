...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderFraudScore
   * @version 2.0.4
   */

  /**
   * Constructs a new <code>OrderFraudScore</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderFraudScore
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderFraudScore} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderFraudScore} The populated <code>OrderFraudScore</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('distance_km')) {
        obj['distance_km'] = ApiClient.convertToType(data['distance_km'], 'Integer');
      }
   ...
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderFraudScore.BinMatchEnum} bin_match
   */
