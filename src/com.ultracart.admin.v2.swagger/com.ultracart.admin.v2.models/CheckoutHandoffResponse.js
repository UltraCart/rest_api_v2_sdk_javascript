...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CheckoutHandoffResponse
   * @version 2.0.5
   */

  /**
   * Constructs a new <code>CheckoutHandoffResponse</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CheckoutHandoffResponse
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CheckoutHandoffResponse} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CheckoutHandoffResponse} The populated <code>CheckoutHandoffResponse</code> instance.
   */
