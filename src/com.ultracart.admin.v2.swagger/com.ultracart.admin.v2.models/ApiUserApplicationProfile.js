...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ApiUserApplicationProfile
   * @version 2.1.0
   */

  /**
   * Constructs a new <code>ApiUserApplicationProfile</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ApiUserApplicationProfile
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ApiUserApplicationProfile} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ApiUserApplicationProfile} The populated <code>ApiUserApplicationProfile</code> instance.
   */
