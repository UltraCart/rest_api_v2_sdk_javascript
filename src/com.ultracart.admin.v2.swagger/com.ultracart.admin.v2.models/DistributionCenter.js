...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/DistributionCenter
   * @version 2.0.8
   */

  /**
   * Constructs a new <code>DistributionCenter</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/DistributionCenter
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/DistributionCenter} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/DistributionCenter} The populated <code>DistributionCenter</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('estimate_from_distribution_center_oid')) {
        obj['estimate_from_distribution_center_oid'] = ApiClient.convertToType(data['estimate_from_distribution_center_oid'], 'Integer');
      }
      ...
      if (data.hasOwnProperty('hold_before_shipment_minutes')) {
        obj['hold_before_shipment_minutes'] = ApiClient.convertToType(data['hold_before_shipment_minutes'], 'Integer');
      }
      ...
      if (data.hasOwnProperty('process_days')) {
        obj['process_days'] = ApiClient.convertToType(data['process_days'], 'Integer');
      }
   ...
   * @member {Integer} estimate_from_distribution_center_oid
   */
   ...
   * @member {Integer} hold_before_shipment_minutes
   */
