...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderItemOption
   * @version 2.0.2
   */

  /**
   * Constructs a new <code>OrderItemOption</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderItemOption
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderItemOption} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderItemOption} The populated <code>OrderItemOption</code> instance.
   */
   ...
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderItemOption.AdditionalDimensionApplicationEnum} additional_dimension_application
   */
  exports.prototype['additional_dimension_application'] = undefined;
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Currency} cost_change
   */
  exports.prototype['cost_change'] = undefined;
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderItemOptionFileAttachment} file_attachment
   */
