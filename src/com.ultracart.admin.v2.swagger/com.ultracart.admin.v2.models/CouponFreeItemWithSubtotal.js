...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponFreeItemWithSubtotal
   * @version 2.0.4
   */

  /**
   * Constructs a new <code>CouponFreeItemWithSubtotal</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponFreeItemWithSubtotal
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponFreeItemWithSubtotal} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponFreeItemWithSubtotal} The populated <code>CouponFreeItemWithSubtotal</code> instance.
   */
