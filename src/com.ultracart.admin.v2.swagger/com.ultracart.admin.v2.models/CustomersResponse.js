...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CustomersResponse
   * @version 2.1.0
   */

  /**
   * Constructs a new <code>CustomersResponse</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CustomersResponse
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CustomersResponse} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CustomersResponse} The populated <code>CustomersResponse</code> instance.
   */
  ...
  /**
   * @member {Array.<module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Customer>} customers
   */
