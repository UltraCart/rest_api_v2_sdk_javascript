...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemInstantPaymentNotification
   * @version 2.1.0
   */

  /**
   * Constructs a new <code>ItemInstantPaymentNotification</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemInstantPaymentNotification
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemInstantPaymentNotification} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemInstantPaymentNotification} The populated <code>ItemInstantPaymentNotification</code> instance.
   */
