...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartKitComponentOption
   * @version 2.0.4
   */

  /**
   * Constructs a new <code>CartKitComponentOption</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartKitComponentOption
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartKitComponentOption} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartKitComponentOption} The populated <code>CartKitComponentOption</code> instance.
   */
  ...
  /**
   * Type of option
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartKitComponentOption.TypeEnum} type
   */
