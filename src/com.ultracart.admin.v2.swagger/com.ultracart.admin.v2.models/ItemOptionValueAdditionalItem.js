...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemOptionValueAdditionalItem
   * @version 2.0.6
   */

  /**
   * Constructs a new <code>ItemOptionValueAdditionalItem</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemOptionValueAdditionalItem
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemOptionValueAdditionalItem} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemOptionValueAdditionalItem} The populated <code>ItemOptionValueAdditionalItem</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('additional_merchant_item_oid')) {
        obj['additional_merchant_item_oid'] = ApiClient.convertToType(data['additional_merchant_item_oid'], 'Integer');
      }
    }
    return obj;
  }
