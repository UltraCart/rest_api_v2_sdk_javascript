...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemVariantItem
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>ItemVariantItem</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemVariantItem
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemVariantItem} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemVariantItem} The populated <code>ItemVariantItem</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('variant_merchant_item_oid')) {
        obj['variant_merchant_item_oid'] = ApiClient.convertToType(data['variant_merchant_item_oid'], 'Integer');
      }
