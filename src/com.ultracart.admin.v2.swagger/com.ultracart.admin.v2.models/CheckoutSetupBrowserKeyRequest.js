...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CheckoutSetupBrowserKeyRequest
   * @version 2.0.9
   */

  /**
   * Constructs a new <code>CheckoutSetupBrowserKeyRequest</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CheckoutSetupBrowserKeyRequest
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CheckoutSetupBrowserKeyRequest} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CheckoutSetupBrowserKeyRequest} The populated <code>CheckoutSetupBrowserKeyRequest</code> instance.
   */
