...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponAmountOffShippingWithItemsPurchase
   * @version 2.0.7
   */

  /**
   * Constructs a new <code>CouponAmountOffShippingWithItemsPurchase</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponAmountOffShippingWithItemsPurchase
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponAmountOffShippingWithItemsPurchase} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponAmountOffShippingWithItemsPurchase} The populated <code>CouponAmountOffShippingWithItemsPurchase</code> instance.
   */
