...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderItemEdiIdentification
   * @version 2.1.0
   */

  /**
   * Constructs a new <code>OrderItemEdiIdentification</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderItemEdiIdentification
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderItemEdiIdentification} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderItemEdiIdentification} The populated <code>OrderItemEdiIdentification</code> instance.
   */
