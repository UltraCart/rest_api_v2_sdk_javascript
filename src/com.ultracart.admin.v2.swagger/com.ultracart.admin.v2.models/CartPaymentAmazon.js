...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartPaymentAmazon
   * @version 2.0.7
   */

  /**
   * Constructs a new <code>CartPaymentAmazon</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartPaymentAmazon
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartPaymentAmazon} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartPaymentAmazon} The populated <code>CartPaymentAmazon</code> instance.
   */
