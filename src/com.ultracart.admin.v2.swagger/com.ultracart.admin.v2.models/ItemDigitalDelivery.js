...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['com.ultracart.admin.v2.swagger/ApiClient', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemDigitalItem'], factory);
   ...
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemDigitalDelivery
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemDigitalDelivery} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemDigitalDelivery} The populated <code>ItemDigitalDelivery</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('activation_code_low_warning')) {
        obj['activation_code_low_warning'] = ApiClient.convertToType(data['activation_code_low_warning'], 'Integer');
      }
