...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['com.ultracart.admin.v2.swagger/ApiClient', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Order'], factory);
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ChargebackDispute
   * @version 2.0.4
   */

  /**
   * Constructs a new <code>ChargebackDispute</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ChargebackDispute
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ChargebackDispute} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ChargebackDispute} The populated <code>ChargebackDispute</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('chargeback_dispute_oid')) {
        obj['chargeback_dispute_oid'] = ApiClient.convertToType(data['chargeback_dispute_oid'], 'Integer');
      }
      ...
      if (data.hasOwnProperty('fax_transaction_id')) {
        obj['fax_transaction_id'] = ApiClient.convertToType(data['fax_transaction_id'], 'Integer');
      }
      ...
      if (data.hasOwnProperty('merchant_account_profile_oid')) {
        obj['merchant_account_profile_oid'] = ApiClient.convertToType(data['merchant_account_profile_oid'], 'Integer');
      }
   ...
   * @member {Integer} chargeback_dispute_oid
   */
  ...
  /**
   * Fax transaction id
   * @member {Integer} fax_transaction_id
   */
   ...
   * @member {Integer} merchant_account_profile_oid
   */
