...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['com.ultracart.admin.v2.swagger/ApiClient', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemEbayMarketListing'], factory);
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemEbayMarketPlaceAnalysis
   * @version 2.0.6
   */

  /**
   * Constructs a new <code>ItemEbayMarketPlaceAnalysis</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemEbayMarketPlaceAnalysis
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemEbayMarketPlaceAnalysis} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemEbayMarketPlaceAnalysis} The populated <code>ItemEbayMarketPlaceAnalysis</code> instance.
   */
  ...
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemEbayMarketListing} our_listing
   */
