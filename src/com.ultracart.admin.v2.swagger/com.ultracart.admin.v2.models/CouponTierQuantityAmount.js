...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponTierQuantityAmount
   * @version 2.0.6
   */

  /**
   * Constructs a new <code>CouponTierQuantityAmount</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponTierQuantityAmount
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponTierQuantityAmount} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponTierQuantityAmount} The populated <code>CouponTierQuantityAmount</code> instance.
   */
