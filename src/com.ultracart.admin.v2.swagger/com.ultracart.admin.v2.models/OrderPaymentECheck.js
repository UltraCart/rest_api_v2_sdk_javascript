...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderPaymentECheck
   * @version 2.0.5
   */

  /**
   * Constructs a new <code>OrderPaymentECheck</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderPaymentECheck
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderPaymentECheck} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderPaymentECheck} The populated <code>OrderPaymentECheck</code> instance.
   */
  ...
  /**
   * Bank account type
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderPaymentECheck.BankAccountTypeEnum} bank_account_type
   */
  ...
  /**
   * Bank owner type
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderPaymentECheck.BankOwnerTypeEnum} bank_owner_type
   */
