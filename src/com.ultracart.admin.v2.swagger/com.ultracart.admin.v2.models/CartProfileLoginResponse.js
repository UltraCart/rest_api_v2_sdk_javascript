...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartProfileLoginResponse
   * @version 2.0.9
   */

  /**
   * Constructs a new <code>CartProfileLoginResponse</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartProfileLoginResponse
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartProfileLoginResponse} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartProfileLoginResponse} The populated <code>CartProfileLoginResponse</code> instance.
   */
