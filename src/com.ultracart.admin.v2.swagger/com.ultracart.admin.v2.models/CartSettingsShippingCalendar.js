...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsShippingCalendar
   * @version 2.0.6
   */

  /**
   * Constructs a new <code>CartSettingsShippingCalendar</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsShippingCalendar
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsShippingCalendar} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartSettingsShippingCalendar} The populated <code>CartSettingsShippingCalendar</code> instance.
   */
