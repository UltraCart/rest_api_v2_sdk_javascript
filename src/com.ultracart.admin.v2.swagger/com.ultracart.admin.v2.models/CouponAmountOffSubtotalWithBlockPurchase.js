...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponAmountOffSubtotalWithBlockPurchase
   * @version 2.0.5
   */

  /**
   * Constructs a new <code>CouponAmountOffSubtotalWithBlockPurchase</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponAmountOffSubtotalWithBlockPurchase
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponAmountOffSubtotalWithBlockPurchase} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CouponAmountOffSubtotalWithBlockPurchase} The populated <code>CouponAmountOffSubtotalWithBlockPurchase</code> instance.
   */
