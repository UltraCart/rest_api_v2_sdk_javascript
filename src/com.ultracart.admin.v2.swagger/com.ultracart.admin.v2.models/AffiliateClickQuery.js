...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/AffiliateClickQuery
   * @version 2.0.9
   */

  /**
   * Constructs a new <code>AffiliateClickQuery</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/AffiliateClickQuery
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/AffiliateClickQuery} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/AffiliateClickQuery} The populated <code>AffiliateClickQuery</code> instance.
   */
