...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['com.ultracart.admin.v2.swagger/ApiClient', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Currency', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Distance', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderItemEdi', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderItemOption', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Weight'], factory);
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderItem
   * @version 2.0.3
   */

  /**
   * Constructs a new <code>OrderItem</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderItem
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderItem} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderItem} The populated <code>OrderItem</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('item_reference_oid')) {
        obj['item_reference_oid'] = ApiClient.convertToType(data['item_reference_oid'], 'Integer');
      }
  ...
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Currency} cost
   */
  ...
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Weight} discount_shipping_weight
   */
  ...
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderItemEdi} edi
   */
   ...
   * @member {Integer} item_reference_oid
   */
  ...
  /**
   * Options
   * @member {Array.<module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderItemOption>} options
   */
  ...
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Currency} taxable_cost
   */
