...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderQuery
   * @version 2.0.4
   */

  /**
   * Constructs a new <code>OrderQuery</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderQuery
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderQuery} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderQuery} The populated <code>OrderQuery</code> instance.
   */
   ...
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderQuery.CurrentStageEnum} current_stage
   */
  ...
  /**
   * Payment method
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/OrderQuery.PaymentMethodEnum} payment_method
   */
