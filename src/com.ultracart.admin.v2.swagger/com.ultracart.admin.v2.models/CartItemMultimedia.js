...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['com.ultracart.admin.v2.swagger/ApiClient', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartItemMultimediaThumbnail'], factory);
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartItemMultimedia
   * @version 2.0.4
   */

  /**
   * Constructs a new <code>CartItemMultimedia</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartItemMultimedia
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartItemMultimedia} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartItemMultimedia} The populated <code>CartItemMultimedia</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('image_height')) {
        obj['image_height'] = ApiClient.convertToType(data['image_height'], 'Integer');
      }
      if (data.hasOwnProperty('image_width')) {
        obj['image_width'] = ApiClient.convertToType(data['image_width'], 'Integer');
      }
  ...
  /**
   * Image height
   * @member {Integer} image_height
   */
  exports.prototype['image_height'] = undefined;
  /**
   * Image width
   * @member {Integer} image_width
   */
   ...
   * @member {Array.<module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartItemMultimediaThumbnail>} thumbnails
   */
  exports.prototype['thumbnails'] = undefined;
  /**
   * Type of multimedia
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartItemMultimedia.TypeEnum} type
   */
