...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['com.ultracart.admin.v2.swagger/ApiClient', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemPricingTier'], factory);
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemPricing
   * @version 2.0.3
   */

  /**
   * Constructs a new <code>ItemPricing</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemPricing
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemPricing} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemPricing} The populated <code>ItemPricing</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('automatic_pricing_tier_oid')) {
        obj['automatic_pricing_tier_oid'] = ApiClient.convertToType(data['automatic_pricing_tier_oid'], 'Integer');
      }
      ...
      if (data.hasOwnProperty('mix_and_match_group_oid')) {
        obj['mix_and_match_group_oid'] = ApiClient.convertToType(data['mix_and_match_group_oid'], 'Integer');
      }
