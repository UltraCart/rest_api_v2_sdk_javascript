...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemAutoOrderStepArbitraryUnitCostSchedule
   * @version 2.0.8
   */

  /**
   * Constructs a new <code>ItemAutoOrderStepArbitraryUnitCostSchedule</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemAutoOrderStepArbitraryUnitCostSchedule
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemAutoOrderStepArbitraryUnitCostSchedule} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemAutoOrderStepArbitraryUnitCostSchedule} The populated <code>ItemAutoOrderStepArbitraryUnitCostSchedule</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('retry_days')) {
        obj['retry_days'] = ApiClient.convertToType(data['retry_days'], 'Integer');
      }
    }
    return obj;
  }
