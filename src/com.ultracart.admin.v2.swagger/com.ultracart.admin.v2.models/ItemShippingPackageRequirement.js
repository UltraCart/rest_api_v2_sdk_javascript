...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemShippingPackageRequirement
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>ItemShippingPackageRequirement</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemShippingPackageRequirement
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemShippingPackageRequirement} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemShippingPackageRequirement} The populated <code>ItemShippingPackageRequirement</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('package_oid')) {
        obj['package_oid'] = ApiClient.convertToType(data['package_oid'], 'Integer');
      }
    }
    return obj;
  }
