...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['com.ultracart.admin.v2.swagger/ApiClient', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/AffiliateClick', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/AffiliateLink', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Order'], factory);
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/AffiliateLedger
   * @version 2.0.9
   */

  /**
   * Constructs a new <code>AffiliateLedger</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/AffiliateLedger
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/AffiliateLedger} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/AffiliateLedger} The populated <code>AffiliateLedger</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('affiliate_click_oid')) {
        obj['affiliate_click_oid'] = ApiClient.convertToType(data['affiliate_click_oid'], 'Integer');
      }
   ...
   * @member {Integer} affiliate_click_oid
   */
  ...
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/AffiliateClick} click
   */
  ...
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/AffiliateLink} link
   */
  ...
  /**
   * Transaction state
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/AffiliateLedger.TransactionStateEnum} transaction_state
   */
