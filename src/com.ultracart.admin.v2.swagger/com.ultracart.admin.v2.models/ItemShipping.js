...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemShipping
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>ItemShipping</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemShipping
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemShipping} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemShipping} The populated <code>ItemShipping</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('case_inner_packs')) {
        obj['case_inner_packs'] = ApiClient.convertToType(data['case_inner_packs'], 'Integer');
      }
      if (data.hasOwnProperty('case_units')) {
        obj['case_units'] = ApiClient.convertToType(data['case_units'], 'Integer');
      }
      ...
      if (data.hasOwnProperty('made_to_order_lead_time')) {
        obj['made_to_order_lead_time'] = ApiClient.convertToType(data['made_to_order_lead_time'], 'Integer');
      }
      if (data.hasOwnProperty('max_days_time_in_transit')) {
        obj['max_days_time_in_transit'] = ApiClient.convertToType(data['max_days_time_in_transit'], 'Integer');
      }
      ...
      if (data.hasOwnProperty('perishable_class_oid')) {
        obj['perishable_class_oid'] = ApiClient.convertToType(data['perishable_class_oid'], 'Integer');
      }
  ...
  /**
   * @member {Integer} case_inner_packs
   */
  exports.prototype['case_inner_packs'] = undefined;
  /**
   * @member {Integer} case_units
   */
   ...
   */
  exports.prototype['country_of_origin'] = undefined;
  /**
  ...
  /**
   * @member {Array.<module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemShippingDestinationMarkup>} destination_markups
   */
  exports.prototype['destination_markups'] = undefined;
  /**
   * @member {Array.<module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemShippingDestinationRestriction>} destination_restrictions
   */
  exports.prototype['destination_restrictions'] = undefined;
  /**
   * @member {Array.<module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemShippingDistributionCenter>} distribution_centers
   */
  ...
  /**
   * @member {Integer} made_to_order_lead_time
   */
  exports.prototype['made_to_order_lead_time'] = undefined;
  /**
   * @member {Integer} max_days_time_in_transit
   */
  exports.prototype['max_days_time_in_transit'] = undefined;
  /**
   * @member {Array.<module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemShippingMethod>} methods
   */
  ...
  /**
   * @member {Array.<module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemShippingPackageRequirement>} package_requirements
   */
  exports.prototype['package_requirements'] = undefined;
  /**
   * @member {Integer} perishable_class_oid
   */
  ...
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Weight} ship_separately_additional_weight
   */
  exports.prototype['ship_separately_additional_weight'] = undefined;
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Distance} ship_separately_height
   */
  exports.prototype['ship_separately_height'] = undefined;
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Distance} ship_separately_length
   */
  ...
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/Distance} ship_separately_width
   */
