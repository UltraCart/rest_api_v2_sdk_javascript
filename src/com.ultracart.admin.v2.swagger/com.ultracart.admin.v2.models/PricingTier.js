...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['com.ultracart.admin.v2.swagger/ApiClient', 'com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/PricingTierNotification'], factory);
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/PricingTier
   * @version 2.0.9
   */

  /**
   * Constructs a new <code>PricingTier</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/PricingTier
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/PricingTier} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/PricingTier} The populated <code>PricingTier</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('default_shipping_method_oid')) {
        obj['default_shipping_method_oid'] = ApiClient.convertToType(data['default_shipping_method_oid'], 'Integer');
      }
  ...
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/PricingTierNotification} approval_notification
   */
   ...
   * @member {Integer} default_shipping_method_oid
   */
  ...
  /**
   * @member {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/PricingTierNotification} signup_notification
   */
