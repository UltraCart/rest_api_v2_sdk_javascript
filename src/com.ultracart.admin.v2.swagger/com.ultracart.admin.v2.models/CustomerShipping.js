...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CustomerShipping
   * @version 2.0.6
   */

  /**
   * Constructs a new <code>CustomerShipping</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CustomerShipping
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CustomerShipping} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CustomerShipping} The populated <code>CustomerShipping</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('customer_shipping_oid')) {
        obj['customer_shipping_oid'] = ApiClient.convertToType(data['customer_shipping_oid'], 'Integer');
      }
   ...
   * @member {Integer} customer_shipping_oid
   */
