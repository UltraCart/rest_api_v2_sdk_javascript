...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartItemVariationSelection
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>CartItemVariationSelection</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartItemVariationSelection
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartItemVariationSelection} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartItemVariationSelection} The populated <code>CartItemVariationSelection</code> instance.
   */
