...
(function(root, factory) {
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartValidationResponse
   * @version 2.0.8
   */

  /**
   * Constructs a new <code>CartValidationResponse</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartValidationResponse
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartValidationResponse} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/CartValidationResponse} The populated <code>CartValidationResponse</code> instance.
   */
