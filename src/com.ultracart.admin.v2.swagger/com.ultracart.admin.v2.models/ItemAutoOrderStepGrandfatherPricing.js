...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.UltraCartRestApiV2.ItemAutoOrderStepGrandfatherPricing = factory(root.UltraCartRestApiV2.ApiClient);
  }
   ...
   * @module com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemAutoOrderStepGrandfatherPricing
   * @version 2.0.2
   */

  /**
   * Constructs a new <code>ItemAutoOrderStepGrandfatherPricing</code>.
   * @alias module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemAutoOrderStepGrandfatherPricing
   * @class
   */
   ...
   * @param {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemAutoOrderStepGrandfatherPricing} obj Optional instance to populate.
   * @return {module:com.ultracart.admin.v2.swagger/com.ultracart.admin.v2.models/ItemAutoOrderStepGrandfatherPricing} The populated <code>ItemAutoOrderStepGrandfatherPricing</code> instance.
   */
