...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'com.ultracart.admin.v2.models/EmailSegmentCustomer'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EmailSegmentCustomer'));
  } else {
    // Browser globals (root is window)
    if (!root.UltraCartRestApiV2) {
      root.UltraCartRestApiV2 = {};
    }
    root.UltraCartRestApiV2.EmailSegmentCustomersResponse = factory(root.UltraCartRestApiV2.ApiClient, root.UltraCartRestApiV2.EmailSegmentCustomer);
  }
}(this, function(ApiClient, EmailSegmentCustomer) {
  'use strict';
