...
class AutoOrdersResponse {
    ...
    constructor() { 
        ...
        AutoOrdersResponse.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AutoOrdersResponse();
 ...
 */
AutoOrdersResponse.prototype['auto_orders'] = undefined;

/**
 * @member {module:com.ultracart.admin.v2.models/Error} error
 */
AutoOrdersResponse.prototype['error'] = undefined;

/**
 * @member {module:com.ultracart.admin.v2.models/ResponseMetadata} metadata
 */
AutoOrdersResponse.prototype['metadata'] = undefined;

/**
 * Indicates if API call was successful
 * @member {Boolean} success
 */
AutoOrdersResponse.prototype['success'] = undefined;

/**
 * @member {module:com.ultracart.admin.v2.models/Warning} warning
 */
AutoOrdersResponse.prototype['warning'] = undefined;
...
export default AutoOrdersResponse;
