    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('max_asset_bytes')) {
                obj['max_asset_bytes'] = ApiClient.convertToType(data['max_asset_bytes'], 'Number');
            }
            ...
            if (data.hasOwnProperty('max_directory_entries')) {
                obj['max_directory_entries'] = ApiClient.convertToType(data['max_directory_entries'], 'Number');
            }
            if (data.hasOwnProperty('max_library_results_per_page')) {
                obj['max_library_results_per_page'] = ApiClient.convertToType(data['max_library_results_per_page'], 'Number');
            }
            if (data.hasOwnProperty('max_menu_depth')) {
                obj['max_menu_depth'] = ApiClient.convertToType(data['max_menu_depth'], 'Number');
            }
            if (data.hasOwnProperty('max_menu_items')) {
                obj['max_menu_items'] = ApiClient.convertToType(data['max_menu_items'], 'Number');
            }
            ...
            if (data.hasOwnProperty('max_revertable_bytes')) {
                obj['max_revertable_bytes'] = ApiClient.convertToType(data['max_revertable_bytes'], 'Number');
            }
            ...
            if (data.hasOwnProperty('max_text_read_bytes')) {
                obj['max_text_read_bytes'] = ApiClient.convertToType(data['max_text_read_bytes'], 'Number');
            }
            if (data.hasOwnProperty('max_video_bytes')) {
                obj['max_video_bytes'] = ApiClient.convertToType(data['max_video_bytes'], 'Number');
            }
