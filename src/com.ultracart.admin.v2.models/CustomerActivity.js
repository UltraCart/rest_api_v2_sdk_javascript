...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'com.ultracart.admin.v2.models/Activity', 'com.ultracart.admin.v2.models/ListSegmentMembership', 'com.ultracart.admin.v2.models/Metric'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Activity'), require('./ListSegmentMembership'), require('./Metric'));
  } else {
    // Browser globals (root is window)
    if (!root.UltraCartRestApiV2) {
      root.UltraCartRestApiV2 = {};
    }
    root.UltraCartRestApiV2.CustomerActivity = factory(root.UltraCartRestApiV2.ApiClient, root.UltraCartRestApiV2.Activity, root.UltraCartRestApiV2.ListSegmentMembership, root.UltraCartRestApiV2.Metric);
  }
}(this, function(ApiClient, Activity, ListSegmentMembership, Metric) {
  'use strict';
