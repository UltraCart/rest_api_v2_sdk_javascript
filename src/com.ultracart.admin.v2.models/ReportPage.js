...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'com.ultracart.admin.v2.models/ReportFilter', 'com.ultracart.admin.v2.models/ReportPageVisualization'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ReportFilter'), require('./ReportPageVisualization'));
  } else {
    // Browser globals (root is window)
    if (!root.UltraCartRestApiV2) {
      root.UltraCartRestApiV2 = {};
    }
    root.UltraCartRestApiV2.ReportPage = factory(root.UltraCartRestApiV2.ApiClient, root.UltraCartRestApiV2.ReportFilter, root.UltraCartRestApiV2.ReportPageVisualization);
  }
}(this, function(ApiClient, ReportFilter, ReportPageVisualization) {
  'use strict';
