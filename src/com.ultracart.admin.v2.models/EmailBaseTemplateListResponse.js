...
class EmailBaseTemplateListResponse {
    ...
    constructor() { 
        ...
        EmailBaseTemplateListResponse.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmailBaseTemplateListResponse();
 ...
 */
EmailBaseTemplateListResponse.prototype['templatePaths'] = undefined;
...
export default EmailBaseTemplateListResponse;
