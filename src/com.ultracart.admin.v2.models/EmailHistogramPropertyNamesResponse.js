...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.UltraCartRestApiV2.EmailHistogramPropertyNamesResponse = factory(root.UltraCartRestApiV2.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('property_names'))
        obj.propertyNames = ApiClient.convertToType(data['property_names'], ['String']);
    }
    return obj;
  }
