    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('acting_as_user')) {
                obj['acting_as_user'] = ApiClient.convertToType(data['acting_as_user'], 'Boolean');
            }
            ...
            if (data.hasOwnProperty('device_scope')) {
                obj['device_scope'] = ApiClient.convertToType(data['device_scope'], 'String');
            }
            ...
            if (data.hasOwnProperty('storefronts_withheld')) {
                obj['storefronts_withheld'] = ApiClient.convertToType(data['storefronts_withheld'], 'Boolean');
            }
