...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'com.ultracart.admin.v2.models/ConversationEngagementEquationGroup'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ConversationEngagementEquationGroup'));
  } else {
    // Browser globals (root is window)
    if (!root.UltraCartRestApiV2) {
      root.UltraCartRestApiV2 = {};
    }
    root.UltraCartRestApiV2.ConversationEngagementEquation = factory(root.UltraCartRestApiV2.ApiClient, root.UltraCartRestApiV2.ConversationEngagementEquationGroup);
  }
}(this, function(ApiClient, ConversationEngagementEquationGroup) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('groups'))
        obj.groups = ApiClient.convertToType(data['groups'], [ConversationEngagementEquationGroup]);
    }
    return obj;
  }
