...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('required_purchase_mix_and_match_group'))
        obj.requiredPurchaseMixAndMatchGroup = ApiClient.convertToType(data['required_purchase_mix_and_match_group'], 'String');
   ...
   * @member {String} requiredPurchaseMixAndMatchGroup
   */
  exports.prototype.requiredPurchaseMixAndMatchGroup = undefined;
