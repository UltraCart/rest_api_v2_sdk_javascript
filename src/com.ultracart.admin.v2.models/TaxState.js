    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('vat_threshold')) {
                obj['vat_threshold'] = ApiClient.convertToType(data['vat_threshold'], 'Number');
            }
            if (data.hasOwnProperty('vat_threshold_currency')) {
                obj['vat_threshold_currency'] = ApiClient.convertToType(data['vat_threshold_currency'], 'String');
            }
        }
        return obj;
    }
