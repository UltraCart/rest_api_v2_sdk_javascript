...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    this.createFsDirectory = function(id, opts, callback) {
      ...
      var contentTypes = ['application/json'];
      var accepts = ['application/json'];
      var returnType = FileManagerPage;
