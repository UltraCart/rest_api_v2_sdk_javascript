...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} error Error message, if any.
     * @param {module:com.ultracart.admin.v2.models/EmailCommseqEmailReviewResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:com.ultracart.admin.v2.models/EmailCommseqEmailReviewResponse}
     */
    this.review = function(storefrontOid, commseqEmailUuid, emailCommseqEmailReviewRequest, callback) {
      ...
      var contentTypes = ['application/json'];
      var accepts = ['application/json'];
      var returnType = EmailCommseqEmailReviewResponse;
