...
export default class CustomerApi {
    ...
    */
     ...
     */
    updateCustomerEmailSuppression(customer_profile_oid, suppression_changes, callback) {
      let postBody = suppression_changes;
      // verify the required parameter 'customer_profile_oid' is set
      if (customer_profile_oid === undefined || customer_profile_oid === null) {
      ...
      let contentTypes = ['application/json; charset=UTF-8'];
      let accepts = ['application/json'];
      let returnType = CustomerEmailSuppressionResponse;
      return this.apiClient.callApi(
        '/customer/customers/{customer_profile_oid}/email_suppression', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
