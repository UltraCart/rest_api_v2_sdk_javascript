...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'com.ultracart.admin.v2.models/ErrorResponse', 'com.ultracart.admin.v2.models/TaxCity', 'com.ultracart.admin.v2.models/TaxCountry', 'com.ultracart.admin.v2.models/TaxCounty', 'com.ultracart.admin.v2.models/TaxPostalCode', 'com.ultracart.admin.v2.models/TaxProviderAvalara', 'com.ultracart.admin.v2.models/TaxProviderSelf', 'com.ultracart.admin.v2.models/TaxProviderTaxJar', 'com.ultracart.admin.v2.models/TaxProviderUltraCart', 'com.ultracart.admin.v2.models/TaxProvidersResponse', 'com.ultracart.admin.v2.models/TaxState'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../com.ultracart.admin.v2.models/ErrorResponse'), require('../com.ultracart.admin.v2.models/TaxCity'), require('../com.ultracart.admin.v2.models/TaxCountry'), require('../com.ultracart.admin.v2.models/TaxCounty'), require('../com.ultracart.admin.v2.models/TaxPostalCode'), require('../com.ultracart.admin.v2.models/TaxProviderAvalara'), require('../com.ultracart.admin.v2.models/TaxProviderSelf'), require('../com.ultracart.admin.v2.models/TaxProviderTaxJar'), require('../com.ultracart.admin.v2.models/TaxProviderUltraCart'), require('../com.ultracart.admin.v2.models/TaxProvidersResponse'), require('../com.ultracart.admin.v2.models/TaxState'));
  } else {
...
}(this, function(ApiClient, ErrorResponse, TaxCity, TaxCountry, TaxCounty, TaxPostalCode, TaxProviderAvalara, TaxProviderSelf, TaxProviderTaxJar, TaxProviderUltraCart, TaxProvidersResponse, TaxState) {
  'use strict';
