...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     */
    this.getInventorySnapshot = function(callback) {
      var postBody = null;
      ...
      var contentTypes = ['application/json'];
      var accepts = ['application/json'];
      var returnType = ItemInventorySnapshotResponse;
