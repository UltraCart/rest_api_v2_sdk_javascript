...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'com.ultracart.admin.v2.models/ErrorResponse', 'com.ultracart.admin.v2.models/WorkflowAttachmentUploadUrlResponse', 'com.ultracart.admin.v2.models/WorkflowGroupsResponse', 'com.ultracart.admin.v2.models/WorkflowTask', 'com.ultracart.admin.v2.models/WorkflowTaskResponse', 'com.ultracart.admin.v2.models/WorkflowTasksRequest', 'com.ultracart.admin.v2.models/WorkflowTasksResponse', 'com.ultracart.admin.v2.models/WorkflowUsersResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../com.ultracart.admin.v2.models/ErrorResponse'), require('../com.ultracart.admin.v2.models/WorkflowAttachmentUploadUrlResponse'), require('../com.ultracart.admin.v2.models/WorkflowGroupsResponse'), require('../com.ultracart.admin.v2.models/WorkflowTask'), require('../com.ultracart.admin.v2.models/WorkflowTaskResponse'), require('../com.ultracart.admin.v2.models/WorkflowTasksRequest'), require('../com.ultracart.admin.v2.models/WorkflowTasksResponse'), require('../com.ultracart.admin.v2.models/WorkflowUsersResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.UltraCartRestApiV2) {
      root.UltraCartRestApiV2 = {};
    }
    root.UltraCartRestApiV2.WorkflowApi = factory(root.UltraCartRestApiV2.ApiClient, root.UltraCartRestApiV2.ErrorResponse, root.UltraCartRestApiV2.WorkflowAttachmentUploadUrlResponse, root.UltraCartRestApiV2.WorkflowGroupsResponse, root.UltraCartRestApiV2.WorkflowTask, root.UltraCartRestApiV2.WorkflowTaskResponse, root.UltraCartRestApiV2.WorkflowTasksRequest, root.UltraCartRestApiV2.WorkflowTasksResponse, root.UltraCartRestApiV2.WorkflowUsersResponse);
  }
}(this, function(ApiClient, ErrorResponse, WorkflowAttachmentUploadUrlResponse, WorkflowGroupsResponse, WorkflowTask, WorkflowTaskResponse, WorkflowTasksRequest, WorkflowTasksResponse, WorkflowUsersResponse) {
  'use strict';
